...
**When you place a sub-node in your graph, you're not running logic — you're describing intent.** The sub-node says _what_ should happen. The consumer node that receives it decides _when_ and _where_.
...
{% step %}
### Runtime Instance (Processing Time)
...
<table data-view="cards"><thead><tr><th>Type</th><th>Purpose</th><th>Combination</th></tr></thead><tbody><tr><td>Filter</td><td>Pass/fail conditions</td><td>Connection order, AND logic</td></tr><tr><td>Probe</td><td>Sampling behaviors</td><td>Results combine</td></tr><tr><td>Heuristics</td><td>Pathfinding costs</td><td>Sum or blend</td></tr><tr><td>Action</td><td>Staged operations</td><td>Priority order</td></tr><tr><td>Shape Builder</td><td>Parametric generation</td><td>N/A</td></tr></tbody></table>
