---
icon: puzzle-piece
description: 'G-Probe : Hub & Spoke - Creates hierarchical hub-and-spoke network topology'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsProbing-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsProbing/Public/Probes/PCGExGlobalProbeHubSpoke.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsProbing/Public/Probes/PCGExGlobalProbeHubSpoke.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 6 documented (HubSelectionMode, NumHubs, HubAttribute, bConnectHubs, bNearestHubOnly, KMeansIterations)
Inherited Properties: FPCGExProbeConfigBase (SearchRadiusInput, SearchRadius, Offset)
Inputs: None
Outputs: Probe (PCGEx | Probe)
Nested Types: FPCGExProbeConfigHubSpoke, EPCGExHubSelectionMode
-->
