---
icon: puzzle-piece
description: 'G-Probe : Theta Graph - Theta/Yao graph spanner connecting to nearest in angular cones'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsProbing-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsProbing/Public/Probes/PCGExGlobalProbeTheta.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsProbing/Public/Probes/PCGExGlobalProbeTheta.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented (NumCones, ConeAxis, bUseYaoVariant)
Inherited Properties: FPCGExProbeConfigBase (SearchRadiusInput, SearchRadius, Offset)
Inputs: None
Outputs: Probe (PCGEx | Probe)
Nested Types: FPCGExProbeConfigTheta
-->
