...
description: 'Cluster : Connect Points - Connect points according to a set of probes.'
---
...
📋 *Visible when Project Points is enabled*
...
📦 **Module**: `PCGExElementsProbing` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsProbing/Public/Elements/PCGExConnectPoints.h)
...
Inputs: In (Point Data), Probes (Probe Factories), Generator Filters (Filter Factories), Connectable Filters (Filter Factories)
Outputs: Vtx (Point Data), Edges (Point Data)
Nested Types: EPCGExOptionState, FPCGExGeo2DProjectionDetails, FPCGExGraphBuilderDetails
-->
