---
icon: hourglass-half
description: 'Wait for PCG Data - Waits for PCG Components to generate and retrieves their output data'
---
...
3. **Trigger Generation**: Based on each component's generation trigger type (OnLoad, OnDemand, AtRuntime), decides whether to wait, generate, or force-regenerate.
...
📋 *Visible when Template Input = Constant*
...
📋 *Visible when Template Input = Attribute*
...
📋 *Visible when Match Generation Trigger is enabled*
...
📋 *Visible when Wait for Missing Actors is enabled*
...
|----------|------|-------------|
| **Add Index Tag** | bool | Add a tag with the point index |
| **Index Tag Prefix** | string | Prefix for the index tag (default: "IndexTag") |
| **Prefix With Attribute Name** | bool | Include attribute name in the tag |
| **Attributes** | array | Attribute selectors to convert to tags |
| **Comma Separated Attribute Selectors** | string | Alternative: comma-separated attribute names |
...
📋 *Visible when Output Roaming is enabled*
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 20 documented
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (Points)
Outputs: Template Pins (dynamic), Roaming Data
Nested Types: EPCGExDataInputValueType, EPCGExGenerationTriggerAction, EPCGExRuntimeGenerationTriggerAction, FPCGExAttributeToTagDetails
-->
