---
icon: table-list
description: 'Bitmask Collection - Data asset that stores named bitmask entries for reusable bitmask configurations.'
---
...
<details>
<summary><strong>Entries</strong> <code>TArray<FPCGExBitmaskCollectionEntry></code></summary>
...
📦 **Module**: `PCGExCore` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCore/Public/Data/Bitmasks/PCGExBitmaskCollection.h)

<!-- VERIFICATION REPORT
Asset Type: UDataAsset (Bitmask Collection Library)
Base Class: UDataAsset
Own Properties: 2 documented (Notes, Entries)
Entry Structure: Identifier (FName), Bitmask (FPCGExBitmask), Direction (FVector)
Purpose: Reusable library of named bitmask configurations
Caching: Internal cache for fast identifier-to-bitmask lookups
Direction: Optional normalized direction vectors per entry
Use Cases: Adjacency libraries, categorical flags, directional filters, shared bitmask configurations
-->
