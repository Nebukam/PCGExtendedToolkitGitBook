...
description: 'Transform Details - Complete transform fitting and inheritance settings'
---
...
→ See [Scale To Fit Details](./FPCGExScaleToFitDetails.md)
...
→ See [Justification Details](./FPCGExJustificationDetails.md)
...
Inherited Properties: None (FPCGExFittingDetailsHandler is internal base)
Nested Types: FPCGExScaleToFitDetails, FPCGExJustificationDetails (referenced)
Used By: Cluster Copy to Points, Mesh to Clusters, Copy to Points
-->
