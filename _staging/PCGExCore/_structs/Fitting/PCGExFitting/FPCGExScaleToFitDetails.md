...
description: 'Scale To Fit Details - Configure how objects scale to match target bounds'
---
...
📋 *Visible when Scale To Fit Mode = Uniform*
...
📋 *Visible when Scale To Fit Mode = Individual*
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (ScaleToFitMode, ScaleToFit, ScaleToFitX, ScaleToFitY, ScaleToFitZ)
Inherited Properties: None
Nested Types: EPCGExFitMode (enum), EPCGExScaleToFit (enum)
