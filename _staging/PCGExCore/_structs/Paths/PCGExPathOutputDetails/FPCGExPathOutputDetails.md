...
📋 *Visible when Remove Small Paths = true*
...
📋 *Visible when Remove Large Paths = true*
...
📦 **Module**: `PCGExCore` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCore/Public/Paths/PCGExPathOutputDetails.h)
