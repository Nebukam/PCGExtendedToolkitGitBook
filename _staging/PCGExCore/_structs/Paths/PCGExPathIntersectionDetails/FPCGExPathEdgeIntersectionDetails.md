---
icon: scissors
description: 'Path Edge Intersection Details - Configure edge/path intersection detection'
---

# Path Edge Intersection Details
...
📋 *Visible when the operation supports self-intersection*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExCore-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCore/Public/Paths/PCGExPathIntersectionDetails.h)
...
Nested Types: None
Used By: Cluster Cut, Path × Path Crossings
-->
