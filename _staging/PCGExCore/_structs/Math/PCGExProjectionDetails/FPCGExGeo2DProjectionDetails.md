---
icon: layer-group
description: 'Geo 2D Projection Details - Configure how 3D points project to 2D planes'
---

# Geo 2D Projection Details
...
📦 **Module**: `PCGExCore` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCore/Public/Math/PCGExProjectionDetails.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 2 documented (Method, ProjectionVector)
Inherited Properties: None
Nested Types: EPCGExProjectionMethod (enum), FPCGExInputShorthandSelectorVector (referenced)
Used By: 19+ nodes including Clipper2, Delaunay 2D, Voronoi 2D, Cell operations, Path operations
-->
