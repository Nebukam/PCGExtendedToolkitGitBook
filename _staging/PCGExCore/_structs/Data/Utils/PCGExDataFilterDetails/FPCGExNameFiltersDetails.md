---
icon: filter
description: 'Name Filters Details - Filter attributes or tags by name patterns'
---
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (FilterMode, Matches, CommaSeparatedNames, CommaSeparatedNameFilter, bPreservePCGExData)
Inherited Properties: None
Nested Types: EPCGExAttributeFilter (enum), EPCGExStringMatchMode (enum)
Used By: Batch Actions, Attribute Stats, Spline to Path, Merge Points by Tag
-->
