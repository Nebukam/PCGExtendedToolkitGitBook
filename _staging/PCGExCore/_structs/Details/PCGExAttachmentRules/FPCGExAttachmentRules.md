---
icon: link
description: 'Attachment Rules - Configure how spawned components attach to parents'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExCore-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCore/Public/Details/PCGExAttachmentRules.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCore/Public/Details/PCGExAttachmentRules.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 4 documented (LocationRule, RotationRule, ScaleRule, bWeldSimulatedBodies)
Inherited Properties: None
Nested Types: EAttachmentRule (Unreal Engine enum)
Used By: Create Spline, Spawn Dynamic Mesh
-->
