---
icon: puzzle-piece
description: 'Fill Controls - Base factory for flood fill control sub-nodes'
---

# Fill Controls (Base Class)
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsFloodFill-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/Core/PCGExFillControlsFactoryProvider.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/Core/PCGExFillControlsFactoryProvider.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 0 (abstract base class)
Inherited Properties: Source, Steps (from FPCGExFillControlConfigBase)
Inputs: N/A (factory provider)
Outputs: Fill Controls (factory data)
Nested Types: FPCGExFillControlConfigBase, EPCGExFloodFillSettingSource, EPCGExFloodFillControlStepsFlags
-->
