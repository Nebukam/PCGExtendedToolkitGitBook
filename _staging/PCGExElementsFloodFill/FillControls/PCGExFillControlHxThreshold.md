---
icon: puzzle-piece
description: 'Fill Control : Heuristics Threshold - Stops diffusion when heuristic score crosses a threshold'
---

# Fill Control : Heuristics Threshold
...
📋 *Visible when Comparison is NearlyEqual or NearlyNotEqual*
...
→ See [Fill Controls Base](../Core/PCGExFillControlsFactoryProvider.md) for: Source

Note: The Steps setting is not available for this control.

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsFloodFill-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlHxThreshold.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlHxThreshold.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 7 documented
Inherited Properties: Referenced to FPCGExFillControlConfigBase (Source only, Steps disabled)
Inputs: Heuristics (heuristic factories)
Outputs: Fill Controls
Nested Types: EPCGExHeuristicScoreMode, EPCGExInputValueType, EPCGExComparison, EPCGExFloodFillThresholdSource
-->
