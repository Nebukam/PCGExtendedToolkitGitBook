---
icon: puzzle-piece
description: 'Fill Control : Keep Direction - Stops diffusion when path direction changes significantly'
---

# Fill Control : Keep Direction
...
📋 *Visible when Window Size Input = Attribute*
...
📋 *Visible when Window Size Input = Constant*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsFloodFill-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlKeepDirection.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlKeepDirection.h -->
...
Nested Types: EPCGExInputValueType, FPCGExVectorHashComparisonDetails
-->
