---
icon: puzzle-piece
description: 'Fill Control : Running Average - Rejects candidates deviating from a running average'
---

# Fill Control : Running Average
...
📋 *Visible when Tolerance Input = Attribute*
...
📋 *Visible when Tolerance Input = Constant*
