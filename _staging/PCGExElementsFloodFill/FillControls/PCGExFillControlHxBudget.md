---
icon: puzzle-piece
description: 'Fill Control : Heuristics Budget - Stops diffusion when accumulated heuristic cost exceeds budget'
---

# Fill Control : Heuristics Budget
...
📋 *Visible when Max Budget Input = Attribute*
...
📋 *Visible when Max Budget Input = Constant*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsFloodFill-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlHxBudget.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlHxBudget.h -->
...
Nested Types: EPCGExHeuristicScoreMode, EPCGExInputValueType, EPCGExFloodFillBudgetSource
-->
