---
icon: puzzle-piece
description: 'Fill Control : Heuristics Scoring - Computes heuristic scores for diffusion candidates'
---

# Fill Control : Heuristics Scoring
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsFloodFill-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlHxScoring.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/FillControls/PCGExFillControlHxScoring.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented
Inherited Properties: None (Source and Steps disabled)
Inputs: Heuristics (heuristic factories)
Outputs: Fill Controls
Nested Types: EPCGExHeuristicScoreMode, EPCGExFloodFillHeuristicFlags
-->
