---
icon: droplet
description: 'Cluster : Flood Fill - Diffuses attributes from seed points across cluster vertices'
---
...
📋 *Visible when Write Diffusion Depth is enabled*
...
📋 *Visible when Write Diffusion Order is enabled*
...
📋 *Visible when Write Diffusion Distance is enabled*
...
📋 *Visible when Write Diffusion Ending is enabled*
...
| Property | Type | Description |
|----------|------|-------------|
| **Enabled** | bool | Enable attribute forwarding |
| **Filter Mode** | enum | All, Include, or Exclude specific attributes |
| **Matches** | map | Attribute name patterns and match modes |
...
📋 *Visible when Path Output = Partitions*
...
📋 *Visible when Path Output is not None*
...
📦 **Module**: `PCGExElementsFloodFill` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsFloodFill/Public/Elements/PCGExFloodFillClusters.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 16 documented
Inherited Properties: Referenced to UPCGExClustersProcessorSettings
Inputs: Vtx, Edges, Seeds, Heuristics (factory), Fill Controls (factory), Blending (factory)
Outputs: Vtx, Edges, Paths
Nested Types: FPCGExFloodFillSeedPickingDetails, EPCGExFloodFillProcessing, FPCGExFloodFillFlowDetails, FPCGExForwardDetails, EPCGExFloodFillPathOutput, EPCGExFloodFillPathPartitions
-->
