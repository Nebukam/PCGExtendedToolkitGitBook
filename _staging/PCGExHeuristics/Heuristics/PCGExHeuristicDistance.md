---
icon: puzzle-piece
description: 'Heuristics : Shortest Distance - Heuristics based on distance.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExHeuristics-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExHeuristics/Public/Heuristics/PCGExHeuristicDistance.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExHeuristics/Public/Heuristics/PCGExHeuristicDistance.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 0 (FPCGExHeuristicConfigShortestDistance is empty, only inherits)
...
Nested Types: FPCGExHeuristicConfigShortestDistance (empty config struct)
Heuristic Category: GoalDependent
Implementation Notes: Uses BoundsSize for distance normalization
-->
