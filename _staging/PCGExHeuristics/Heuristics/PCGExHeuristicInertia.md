---
icon: puzzle-piece
description: 'Heuristics : Inertia - Heuristics based on direction inertia from last visited node.'
---
...
![Static Badge](https://img.shields.io/badge/Module-PCGExHeuristics-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExHeuristics/Public/Heuristics/PCGExHeuristicInertia.h)
...
Nested Types: FPCGExHeuristicConfigInertia
Heuristic Category: TravelDependent
Performance Warning: Documented as "quite expensive" in source
-->
