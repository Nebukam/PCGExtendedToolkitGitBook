---
icon: puzzle-piece
description: 'Heuristics : Azimuth - Heuristics based on direction toward final goal (north star).'
---
...
![Static Badge](https://img.shields.io/badge/Module-PCGExHeuristics-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExHeuristics/Public/Heuristics/PCGExHeuristicAzimuth.h)
...
Nested Types: FPCGExHeuristicConfigAzimuth (empty config struct)
