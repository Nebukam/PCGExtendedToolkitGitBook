---
icon: puzzle-piece
description: 'Heuristics : Gradient - Heuristics based on attribute gradient between nodes.'
---

# Heuristics : Gradient

Heuristics based on attribute gradient between nodes.
...
📦 **Module**: `PCGExHeuristics` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExHeuristics/Public/Heuristics/PCGExHeuristicGradient.h)
...
Nested Types: EPCGExGradientMode (4 options), FPCGExHeuristicGradientConfig
Heuristic Category: FullyStatic
Implementation Notes: Caches attribute values per node; supports distance normalization
-->
