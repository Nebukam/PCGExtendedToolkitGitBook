---
icon: puzzle-piece
description: 'Heuristics : Attribute - Read a vtx or edge attribute as an heuristic value.'
---
...
📋 *Visible when Use Custom Fallback is enabled*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExHeuristics-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExHeuristics/Public/Heuristics/PCGExHeuristicAttribute.h)
...
Nested Types: EPCGExAttributeHeuristicInputMode (3 options), FPCGExHeuristicAttributeConfig
-->
