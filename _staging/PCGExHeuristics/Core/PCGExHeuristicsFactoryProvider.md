---
icon: cog
description: 'Heuristics Definition - Base class for all heuristic computational nodes used in pathfinding.'
---
...
📋 *Hidden when Raw Settings is enabled*
...
📋 *Visible when Use Local Curve = true and Raw Settings = false*

</details>

<details>
<summary><strong>Score Curve (Asset)</strong> <code>TSoftObjectPtr<UCurveFloat></code></summary>
...
📋 *Visible when Use Local Curve = false and Raw Settings = false*
...
- WeightFactor, bInvert, bUseLocalCurve, LocalScoreCurve, ScoreCurve, ScoreCurveLookup
- bUseLocalWeightMultiplier, LocalWeightMultiplierSource, WeightMultiplierAttribute
- UVWSeed, UVWGoal
- bRawSettings (internal, not user-facing)
Inherited Properties: None (this IS the base class)
Inputs: N/A (abstract base)
Outputs: Heuristics pin (in derived classes)
Nested Types: FPCGExHeuristicConfigBase, UPCGExHeuristicsFactoryData, UPCGExHeuristicsFactoryProviderSettings
Note: This is an abstract base class - users interact with concrete heuristic implementations
-->
