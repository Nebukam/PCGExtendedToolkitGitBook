...
→ See [Clipper2 Processor Settings](../Core/PCGExClipper2Processor.md) for: Path matching, carry-over attributes, and blending options.

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTopology-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTopology/Public/Elements/PCGExClipper2Triangulate.h)
