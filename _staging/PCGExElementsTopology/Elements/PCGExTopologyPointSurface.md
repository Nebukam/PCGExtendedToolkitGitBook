...
description: 'Topology : Point Surface - Create a Delaunay triangulated surface for each input dataset.'
---
...
📋 *Visible when Attempt Repair = true*
...
📦 **Module**: `PCGExElementsTopology` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTopology/Public/Elements/PCGExTopologyPointSurface.h)
...
Nested Types: FPCGExGeo2DProjectionDetails, FPCGExTopologyDetails
-->
