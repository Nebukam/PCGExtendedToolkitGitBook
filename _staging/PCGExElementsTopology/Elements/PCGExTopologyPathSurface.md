---
icon: route
description: 'Topology : Path Surface - Create a surface mesh from closed paths.'
---
...
→ See [Path Processor Settings](../../PCGExFoundations/Core/PCGExPathProcessor.md) for: Path validation and invalid path filtering options.
...
Inputs: Paths (inherited from path processor)
Outputs: Mesh (PCG Dynamic Mesh)
Nested Types: FPCGExTopologyDetails, FPCGExTopologyUVDetails, EPCGExOptionState
-->
