...
description: 'Topology : Cluster Surface - Create a cluster surface topology from point clusters.'
---
...
→ See [Topology Clusters Processor](../Core/PCGExTopologyClustersProcessor.md) for all settings including:
...
→ See [Clusters Processor Settings](../../PCGEx/Core/PCGExClustersProcessor.md) for: Cluster handling and point data options.
...
Inherited Properties: Referenced to UPCGExTopologyClustersProcessorSettings and UPCGExClustersProcessorSettings
Inputs: Vtx, Edges, Edge Constraints (inherited)
Outputs: Mesh (PCG Dynamic Mesh)
Nested Types: Uses inherited types from base
-->
