---
icon: shapes
description: 'Topology Details - Configure mesh generation from points and paths'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTopology-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTopology/Public/PCGExTopology.h)
...
Nested Types: FPCGExTopologyUVDetails, FGeometryScript* types
Used By: Clipper2 Triangulate, Topology Path Surface, Topology Point Surface, Topology Cluster Surface
-->
