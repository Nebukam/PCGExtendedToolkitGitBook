---
icon: tag
description: 'Goal Picker : Index Attribute - Reads goal indices from seed point attributes'
---
...
→ See [Goal Picker : Default](PCGExGoalPicker.md) for Index Safety settings.

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfinding-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/GoalPickers/PCGExGoalPickerAttribute.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/GoalPickers/PCGExGoalPickerAttribute.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 4 documented (GoalCount, SingleSelector, CommaSeparatedNames, AttributeSelectors)
Inherited Properties: IndexSafety (from UPCGExGoalPicker)
Base Class: UPCGExGoalPicker
Nested Types: EPCGExGoalPickAttributeAmount
-->
