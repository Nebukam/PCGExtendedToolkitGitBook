---
icon: crosshairs
description: 'Goal Picker : Default - Base goal picker using seed index to select goals'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfinding-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/GoalPickers/PCGExGoalPicker.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/GoalPickers/PCGExGoalPicker.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (IndexSafety)
Base Class: UPCGExInstancedFactory
