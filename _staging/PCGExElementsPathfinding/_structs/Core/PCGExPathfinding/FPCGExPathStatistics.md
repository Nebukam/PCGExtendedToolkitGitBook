---
icon: chart-bar
description: 'Path Statistics - Track vertex and edge usage across paths'
---
...
📋 *Visible when Write Point Use Count = true*
...
📋 *Visible when Write Edge Use Count = true*
...
Nested Types: None
Used By: Pathfinding Edges, Pathfinding Grow Paths, Pathfinding Plot Edges
-->
