---
icon: bell
description: 'Search Algorithm : Bellman-Ford - Pathfinding that handles negative edge weights'
---

# Search Algorithm : Bellman-Ford
...
→ See [Search Algorithm : Base](PCGExSearchOperation.md) for Early Exit setting.

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfinding-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Search/PCGExSearchBellmanFord.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Search/PCGExSearchBellmanFord.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (bDetectNegativeCycles)
Inherited Properties: bEarlyExit (from UPCGExSearchInstancedFactory)
Base Class: UPCGExSearchInstancedFactory
-->
