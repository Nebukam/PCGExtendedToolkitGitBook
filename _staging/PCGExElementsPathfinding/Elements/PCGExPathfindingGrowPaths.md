---
icon: seedling
description: 'Pathfinding : Grow Paths - Grows paths from seed points through cluster graphs'
---
...
> Note : This node is deprecated; use Flood Fill instead.
...
📋 *Visible when Num Iterations = Seed/Vtx Attribute*
...
📋 *Visible when Use Growth Stop is enabled*
...
📋 *Visible when Use No Growth is enabled*
...
→ See [Clusters Processor Settings](../Core/PCGExClustersProcessor.md) for common cluster processing settings.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfinding-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Elements/PCGExPathfindingGrowPaths.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Elements/PCGExPathfindingGrowPaths.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 25+ documented
  - SeedPicking, HeuristicScoreMode, GrowthMode
  - NumIterations, NumIterationsAttribute, NumIterationsConstant, NumIterationsUpdateMode
  - SeedNumBranches, SeedNumBranchesMean, NumBranchesConstant, NumBranchesAttribute
  - GrowthDirection, GrowthDirectionAttribute, GrowthDirectionConstant, GrowthDirectionUpdateMode
  - GrowthMaxDistance, GrowthMaxDistanceAttribute, GrowthMaxDistanceConstant
  - bUseGrowthStop, GrowthStopAttribute, bInvertGrowthStop
  - bUseNoGrowth, NoGrowthAttribute, bInvertNoGrowth
  - SeedAttributesToPathTags, SeedForwarding, Statistics, bUseOctreeSearch
Inherited Properties: Referenced to UPCGExClustersProcessorSettings
Inputs: Vtx (Points), Edges (Points), Seeds (Points), Heuristics (Params)
Outputs: Paths (Points), Vtx (Points), Edges (Points)
Nested Types: EPCGExGrowthIterationMode, EPCGExGrowthValueSource, EPCGExGrowthUpdateMode, EPCGExMeanMeasure
-->
