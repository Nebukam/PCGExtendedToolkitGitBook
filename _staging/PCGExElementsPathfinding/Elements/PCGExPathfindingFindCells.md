---
icon: shapes
description: 'Pathfinding : Find Cells - Finds closed cells around seed points'
---
...
📋 *Visible when Write Expansion Attributes is enabled*
...
📋 *Visible when Output Filtered Seeds is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfinding-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Elements/PCGExPathfindingFindCells.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Elements/PCGExPathfindingFindCells.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 14+ documented
  - SeedPicking, SeedOwnership, SortDirection
  - Constraints, Artifacts
  - SeedGrowth, bWriteExpansionAttributes, PickCountAttributeName, DepthAttributeName
  - bOutputFilteredSeeds, SeedMutations
  - ProjectionDetails, SeedAttributesToPathTags, SeedForwarding, bUseOctreeSearch
Inherited Properties: Referenced to UPCGExClustersProcessorSettings
Inputs: Vtx (Points), Edges (Points), Seeds (Points)
Outputs: Paths (Points), Cell Bounds (Points), SeedGenSuccess (Points), SeedGenFailed (Points)
Nested Types: FPCGExNodeSelectionDetails, EPCGExCellSeedOwnership, FPCGExCellConstraintsDetails, FPCGExCellArtifactsDetails, FPCGExCellGrowthDetails, FPCGExCellSeedMutationDetails
-->
