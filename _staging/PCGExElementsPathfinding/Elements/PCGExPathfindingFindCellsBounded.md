---
icon: shapes
description: 'Pathfinding : Find Cells (Bounded) - Finds seed-based cells and classifies them by bounds relationship'
---
...
Inputs: Vtx (Points), Edges (Points), Seeds (Points), Bounds (Points)
Outputs: Multiple based on output mode plus seed success/failure
Nested Types: EPCGExCellTriageOutput, FPCGExNodeSelectionDetails, EPCGExCellSeedOwnership, FPCGExCellConstraintsDetails, FPCGExCellArtifactsDetails
-->
