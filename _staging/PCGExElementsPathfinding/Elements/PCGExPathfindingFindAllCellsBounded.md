---
icon: shapes
description: 'Pathfinding : Find All Cells (Bounded) - Discovers cells and classifies them by spatial bounds relationship'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfinding-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Elements/PCGExPathfindingFindAllCellsBounded.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfinding/Public/Elements/PCGExPathfindingFindAllCellsBounded.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 7 documented (OutputMode, TriageFlags, Constraints, Artifacts, HoleGrowth, ProjectionDetails, bUseOctreeSearch)
Inherited Properties: Referenced to UPCGExClustersProcessorSettings
Inputs: Vtx (Points), Edges (Points), Bounds (Points), Holes (Points)
Outputs: Multiple based on output mode
Nested Types: EPCGExCellTriageOutput, FPCGExCellConstraintsDetails, FPCGExCellArtifactsDetails, FPCGExCellGrowthDetails, FPCGExGeo2DProjectionDetails
-->
