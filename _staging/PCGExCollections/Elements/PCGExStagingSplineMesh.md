---
icon: bezier-curve
description: 'Staging : Spline Mesh - Create spline mesh components from paths using asset collections'
---
...
📋 *Visible when Use Staged Points = false*

</details>

<details>
<summary><strong>Asset Collection</strong> <code>TSoftObjectPtr<UPCGExMeshCollection></code></summary>
...
📋 *Visible when Use Staged Points = false and Collection Source = Asset*
...
📋 *Visible when Use Staged Points = false and Collection Source = Attribute Set*
...
📋 *Visible when Use Staged Points = false and Collection Source = Path Attribute*
...
📋 *Visible when Use Staged Points = true*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExCollections-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExStagingSplineMesh.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExStagingSplineMesh.h -->
...
Inputs: Path Data (In)
Outputs: Path Data (Out)
Nested Types: Multiple structs and enums documented inline
-->
