...
description: 'Tuple : Distribute - Distribute weighted tuple row values across input points.'
---
...
📋 *Visible when Distribution = Index*
...
📋 *Visible when Distribution is not Index*
...
📋 *Visible when Output Row Index is enabled*
...
📋 *Visible when Output Weight is enabled*
...
> See [Points Processor Settings](../../_staging-concepts/shared-settings/points-processor-settings.md) for shared settings.
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 10 documented (Composition, Values, Distribution, IndexSafety, SeedComponents, LocalSeed, bOutputRowIndex, RowIndexAttributeName, bOutputWeight, WeightAttributeName)
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (standard points input)
Outputs: Out (points with tuple attributes)
Nested Types: FPCGExWeightedPropertyOverrides, EPCGExDistribution, EPCGExIndexSafety
-->
