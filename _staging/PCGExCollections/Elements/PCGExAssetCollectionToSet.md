---
icon: table-list
description: 'Asset Collection to Set - Convert an asset collection to an attribute set'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExCollections-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExAssetCollectionToSet.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExAssetCollectionToSet.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 16 documented (AssetCollection, SubCollectionHandling, bAllowDuplicates, bOmitInvalidAndEmpty, and 12 output attribute settings)
Inherited Properties: None specific to document
Inputs: None (parameter node)
Outputs: Attribute Set
Nested Types: EPCGExSubCollectionToSet documented
-->
