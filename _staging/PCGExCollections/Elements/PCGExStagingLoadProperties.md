---
icon: list-check
description: 'Staging : Load Properties - Output property values from staged entries as point attributes'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExCollections-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExStagingLoadProperties.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExStagingLoadProperties.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (PropertyOutputSettings)
Inherited Properties: Referenced to point filtering base class
Inputs: Point Data (In)
Outputs: Point Data (Out)
Nested Types: FPCGExPropertyOutputSettings documented inline
-->
