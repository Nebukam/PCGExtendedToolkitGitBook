---
icon: shapes
description: 'Collection to Module Infos - Convert an asset collection to grammar-friendly module infos'
---
...
📋 *Attribute name is managed internally*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExCollections-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExCollectionToModuleInfos.h)
...
Outputs: Module Infos (attribute set), Labels
Nested Types: EPCGExOptionState documented inline
-->
