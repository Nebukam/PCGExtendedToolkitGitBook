---
icon: plug
description: 'Staging : Load Sockets - Create points from staged data sockets'
---

# Staging : Load Sockets

Create points from staged data sockets.
...
📦 **Module**: `PCGExCollections` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Elements/PCGExStagingLoadSockets.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (OutputSocketDetails with 11 inner properties)
Inherited Properties: Referenced to point filtering base class
Inputs: Point Data (In)
Outputs: Point Data (Out)
Nested Types: FPCGExSocketOutputDetails fully documented
-->
