---
icon: layer-group
description: 'Asset Collection Base - Foundation for all asset collection types'
---
...
<details>
<summary><strong>Collection Tags</strong> <code>TSet<FName></code></summary>
...
📋 *Used when Global Variation Mode = Overrule*
...
📋 *Used when Global Grammar Mode = Overrule*
...
📦 **Module**: `PCGExCollections` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollections/Public/Core/PCGExAssetCollection.h)
...
Inherited Properties: None (base class)
Inputs: N/A (data asset base class)
Outputs: N/A (data asset base class)
Nested Types: Multiple - documented inline where relevant
-->
