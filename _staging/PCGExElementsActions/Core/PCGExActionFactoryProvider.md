---
icon: gear
description: 'Action Factory Base - Abstract base for all action factory types'
---
...
<details>
<summary><strong>Filter Factories</strong> <code>TArray<TObjectPtr<const UPCGExPointFilterFactoryData>></code></summary>
...
📋 *Not overridable, configured by action implementations*
...
Inherited Properties: Inherits from factory base class
Inputs: N/A (abstract base)
Outputs: N/A (abstract base)
Nested Types: FPCGExDataTypeInfoAction metadata type
-->
