---
icon: bolt
description: 'Batch Actions - Execute multiple actions on points in priority order'
---
...
- **Filter Mode**: All, Include, or Exclude
- **Name Patterns**: Comma-separated attribute name patterns
- **Match Mode**: How to match patterns (equals, contains, starts with, etc.)
- **Preserve PCGEx Data**: Whether to preserve PCGEx internal attributes
...
📋 *Visible when Do Consume Processed Attributes is enabled*
...
Inputs: Point Data (In), Action Factories (Actions)
Outputs: Point Data (Out)
Nested Types: FPCGExAttributeGatherDetails, FPCGExNameFiltersDetails documented inline
-->
