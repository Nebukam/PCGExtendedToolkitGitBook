---
icon: map-location
description: 'Pathfinding : Navmesh - Finds paths using Unreal Engine navigation mesh'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPathfindingNavmesh-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfindingNavmesh/Public/Elements/PCGExPathfindingNavmesh.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPathfindingNavmesh/Public/Elements/PCGExPathfindingNavmesh.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 12 documented
  - GoalPicker, Blending (instanced factories)
  - bAddSeedToPath, bAddGoalToPath, bRequireNavigableEndLocation, FuseDistance
...
Inputs: Seeds (Points), Goals (Points)
Outputs: Paths (Points)
Nested Types: EPCGExPathfindingNavmeshMode, FPCGExAttributeToTagDetails, FPCGExForwardDetails
-->
