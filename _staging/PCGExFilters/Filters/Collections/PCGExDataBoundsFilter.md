---
icon: filter
description: 'Data Filter : Bounds - Tests aspects of a data collection bounding box.'
---

# Data Filter : Bounds

Test an aspect of the collection's bounds against a comparison value.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Collections/PCGExDataBoundsFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Collections/PCGExDataBoundsFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExDataBoundsFilterConfig):
- OperandA (EPCGExDataBoundsAspect, default Volume)
- SubOperand (EPCGExDataBoundsComponent, default Length, conditional)
- Ratio (EPCGExDataBoundsRatio, default XY, conditional)
- OperandB (FPCGExCompareSelectorDouble, PCG_Overridable)
- bInvert (bool, default false)
Inherited Properties: From UPCGExFilterCollectionProviderSettings
Classes:
- UPCGExDataBoundsFilterFactory
- UPCGExDataBoundsFilterProviderSettings (display: "Data Filter : Bounds")
Enums: EPCGExDataBoundsAspect, EPCGExDataBoundsComponent, EPCGExDataBoundsRatio
Namespace: PCGExPointFilter::FDataBoundsFilter
-->
