---
icon: filter
description: 'Data Filter : Tag Check - Tests for tag existence on data collections.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Collections/PCGExTagCheckFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Collections/PCGExTagCheckFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExTagCheckFilterConfig):
- Tag (FString, default "Tag", PCG_Overridable)
- Match (EPCGExStringMatchMode, default Equals)
- bStrict (bool, default false)
- bInvert (bool, default false)
Inherited Properties: From UPCGExFilterCollectionProviderSettings
Classes:
- UPCGExTagCheckFilterFactory
- UPCGExTagCheckFilterProviderSettings (display: "Data Filter : Tag Check")
Namespace: PCGExPointFilter::FTagCheckFilter
-->
