---
icon: filter
description: 'Filter : GameplayTags - Tests gameplay tags on referenced actors.'
---

# Filter : GameplayTags

Checks gameplay tags of an actor reference.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExGameplayTagsFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExGameplayTagsFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExGameplayTagsFilterConfig):
- ActorReference (FName, default "ActorReference", PCG_Overridable)
- PropertyPath (FString, default "Component.TagContainer", PCG_Overridable)
- TagQuery (FGameplayTagQuery)
- bFallbackMissingActor (bool, default false)
- bFallbackPropertyPath (bool, default false)
- bQuietMissingPropertyWarning (bool, default false)
Inherited Properties: From UPCGExFilterProviderSettings
Classes:
- UPCGExGameplayTagsFilterFactory
- UPCGExGameplayTagsFilterProviderSettings (display: "Filter : GameplayTags")
Namespace: PCGExPointFilter::FGameplayTagsFilter
