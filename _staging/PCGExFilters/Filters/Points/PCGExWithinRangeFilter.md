---
icon: filter
description: 'Filter : Within Range - Checks if a value falls within a given range.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExWithinRangeFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExWithinRangeFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExWithinRangeFilterConfig):
- OperandA (FPCGAttributePropertyInputSelector, PCG_Overridable)
- Source (EPCGExRangeSource, default Constant, PCG_Overridable)
- Attributes (TArray<FPCGAttributePropertyInputSelector>, conditional, PCG_Overridable)
- RangeMin (double, default -100, conditional, PCG_Overridable)
- RangeMax (double, default 100, conditional, PCG_Overridable)
- bInclusive (bool, default false, PCG_Overridable)
- bInvert (bool, default false, PCG_Overridable)
Inputs: Attribute Set pin (conditional)
Inherited Properties: From UPCGExFilterProviderSettings
Enums: EPCGExRangeSource (Constant, AttributeSet)
Classes:
- UPCGExWithinRangeFilterFactory (base: UPCGExPointFilterFactoryData)
- UPCGExWithinRangeFilterProviderSettings (display: "Filter : Within Range")
Namespace: PCGExPointFilter::FWithinRangeFilter
-->
