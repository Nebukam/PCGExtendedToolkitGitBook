---
icon: filter
description: 'Filter : Modulo Compare - Tests the modulo (remainder) of an attribute value.'
---
...
📋 *Visible when Operand B Source = Attribute*
...
📋 *Visible when Operand B Source = Constant*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExModuloCompareFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExModuloCompareFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExModuloCompareFilterConfig):
- OperandA (FPCGAttributePropertyInputSelector, PCG_Overridable)
- OperandBSource (EPCGExInputValueType, default Constant, PCG_Overridable)
- OperandB (FPCGAttributePropertyInputSelector, conditional, PCG_Overridable)
- OperandBConstant (double, default 2, conditional, PCG_Overridable)
...
- OperandC (FPCGAttributePropertyInputSelector, conditional, PCG_Overridable)
- OperandCConstant (double, default 0, conditional, PCG_Overridable)
- Tolerance (double, conditional, PCG_Overridable)
- ZeroResult (bool, default true, PCG_Overridable)
Inherited Properties: From UPCGExFilterProviderSettings
Classes:
- UPCGExModuloCompareFilterFactory
- UPCGExModuloCompareFilterProviderSettings (display: "Filter : Modulo Compare")
Namespace: PCGExPointFilter::FModuloComparisonFilter
-->
