---
icon: filter
description: 'Filter : Inclusion (Path/Splines) - Tests point containment within path-like shapes.'
---
...
📋 *Visible when Use Min Inclusion Count is enabled*
...
📋 *Visible when Use Max Inclusion Count is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExInclusionFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExInclusionFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExInclusionFilterConfig):
- ProjectionDetails (FPCGExGeo2DProjectionDetails, PCG_Overridable)
- SampleInputs (EPCGExSplineSamplingIncludeMode, default All, PCG_Overridable)
- CheckType (EPCGExSplineCheckType, default IsInside, PCG_Overridable)
- Pick (EPCGExSplineFilterPick, default All, PCG_Overridable)
- Tolerance (double, default 1, PCG_Overridable)
- bSplineScalesTolerance (bool, default false, PCG_Overridable)
- InclusionOffset (double, default 0, PCG_Overridable)
- bUseMinInclusionCount (bool, default false, PCG_Overridable)
- MinInclusionCount (int32, default 2, conditional, PCG_Overridable)
- bUseMaxInclusionCount (bool, default false, PCG_Overridable)
- MaxInclusionCount (int32, default 10, conditional, PCG_Overridable)
- bInvert (bool, default false, PCG_Overridable)
- ExpandZAxis (double, default -1, AdvancedDisplay)
- WindingMutation (EPCGExWindingMutation, default CounterClockwise, AdvancedDisplay)
...
Classes:
- UPCGExInclusionFilterFactory (base: UPCGExPolyPathFilterFactory)
- UPCGExInclusionFilterProviderSettings (display: "Filter : Inclusion (Path/Splines)")
Namespace: PCGExPointFilter::FInclusionFilter
Enums: EPCGExSplineSamplingIncludeMode, EPCGExSplineCheckType, EPCGExSplineFilterPick
-->
