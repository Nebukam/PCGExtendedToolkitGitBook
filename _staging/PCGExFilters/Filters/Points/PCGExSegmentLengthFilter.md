---
icon: filter
description: 'Filter : Segment Length - Compares the distance between the tested point and another inside the same dataset.'
---

# Filter : Segment Length

Compares the distance between the tested point and another point inside the same dataset.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExSegmentLengthFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExSegmentLengthFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExSegmentLengthFilterConfig):
...
- ThresholdConstant (double, default 100, conditional, PCG_Overridable)
- bCompareAgainstSquaredDistance (bool, default false, PCG_NotOverridable)
- Comparison (EPCGExComparison, default StrictlyGreater, PCG_Overridable)
- Tolerance (double, default 0, conditional, PCG_Overridable)
...
- bForceTileIfClosedLoop (bool, default true, PCG_NotOverridable)
- InvalidPointFallback (EPCGExFilterFallback, default Fail, PCG_NotOverridable)
- bInvert (bool, default false, PCG_NotOverridable)
Inherited Properties: From UPCGExFilterProviderSettings
Classes:
- UPCGExSegmentLengthFilterFactory (base: UPCGExPointFilterFactoryData)
- UPCGExSegmentLengthFilterProviderSettings (display: "Filter : Segment Length")
Namespace: PCGExPointFilter::FSegmentLengthFilter
-->
