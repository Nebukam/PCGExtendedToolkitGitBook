---
icon: filter
description: 'Filter : Self Compare (String) - Compares a string attribute against itself at another index.'
---

# Filter : Self Compare (String)

Compares a string attribute value against itself at another index.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExStringSelfCompareFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExStringSelfCompareFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExStringSelfCompareFilterConfig):
...
Classes:
- UPCGExStringSelfCompareFilterFactory (base: UPCGExPointFilterFactoryData)
- UPCGExStringSelfCompareFilterProviderSettings (display: "Filter : Self Compare (String)")
Namespace: PCGExPointFilter::FStringSelfCompareFilter
-->
