---
icon: filter
description: 'Filter : Mean - Tests values against their statistical mean.'
---
...
📋 *Visible when Mean Method = Fixed*
...
📋 *Visible when Mean Method = ModeMin or ModeMax*
...
📋 *Visible when Exclude Below Mean is enabled*
...
📋 *Visible when Exclude Above Mean is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExMeanFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExMeanFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExMeanFilterConfig):
- Target (FPCGAttributePropertyInputSelector)
- Measure (EPCGExMeanMeasure, default Relative, PCG_Overridable)
- MeanMethod (EPCGExMeanMethod, default Average, PCG_Overridable)
- MeanValue (double, default 0, conditional, PCG_Overridable)
- ModeTolerance (double, default 5, conditional, PCG_Overridable)
- bDoExcludeBelowMean (bool, default false, PCG_Overridable)
- ExcludeBelow (double, default 0.2, conditional, PCG_Overridable)
- bDoExcludeAboveMean (bool, default false, PCG_Overridable)
- ExcludeAbove (double, default 0.2, conditional, PCG_Overridable)
- bInvert (bool, default false, PCG_Overridable)
Inherited Properties: From UPCGExFilterProviderSettings
Classes:
- UPCGExMeanFilterFactory
- UPCGExMeanFilterProviderSettings (display: "Filter : Mean")
Namespace: PCGExPointFilter::FMeanFilter
Note: Does not support collection evaluation
-->
