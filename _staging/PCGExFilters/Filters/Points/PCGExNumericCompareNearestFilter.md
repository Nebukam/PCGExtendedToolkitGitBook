---
icon: filter
description: 'Filter : Compare Nearest (Numeric) - Compares a numeric attribute from the nearest target point.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExNumericCompareNearestFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExNumericCompareNearestFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExNumericCompareNearestFilterConfig):
...
Classes:
- UPCGExNumericCompareNearestFilterFactory
- UPCGExNumericCompareNearestFilterProviderSettings (display: "Filter : Compare Nearest (Numeric)")
Namespace: PCGExPointFilter::FNumericCompareNearestFilter
Note: Does not support collection evaluation, requires preparation
-->
