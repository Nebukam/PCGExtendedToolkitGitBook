---
icon: filter
description: 'Filter : Time - Checks point positions against a path/spline closest alpha.'
---

# Filter : Time

Checks point positions against a path/spline/polygon closest alpha.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExTimeFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExTimeFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExTimeFilterConfig):
- SampleInputs (EPCGExSplineSamplingIncludeMode, default All, PCG_Overridable)
- Pick (EPCGExSplineFilterPick, default Closest, PCG_Overridable)
- TimeConsolidation (EPCGExSplineTimeConsolidation, default Min, conditional, PCG_Overridable)
...
- OperandBConstant (float, default 0, conditional, PCG_Overridable)
- Tolerance (double, default DBL_COMPARE_TOLERANCE, conditional, PCG_Overridable)
- bInvert (bool, default false, PCG_Overridable)
- WindingMutation (EPCGExWindingMutation, default Unchanged, AdvancedDisplay, PCG_NotOverridable)
- Fidelity (double, default 50, AdvancedDisplay, PCG_NotOverridable)
...
Inherited Properties: From UPCGExFilterProviderSettings (with Missing Data Policy)
Enums: EPCGExSplineTimeConsolidation (Min, Max, Average)
Classes:
- UPCGExTimeFilterFactory (base: UPCGExPolyPathFilterFactory)
- UPCGExTimeFilterProviderSettings (display: "Filter : Time")
Namespace: PCGExPointFilter::FTimeFilter
-->
