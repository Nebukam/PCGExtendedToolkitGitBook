---
icon: filter
description: 'Filter : Bitmask - Tests point flags using bitwise comparison operations.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExBitmaskFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Filters/Points/PCGExBitmaskFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties:
Config Struct (FPCGExBitmaskFilterConfig):
- FlagsAttribute (FName, default "Flags", PCG_Overridable)
- Comparison (EPCGExBitflagComparison, default MatchPartial)
- MaskInput (EPCGExInputValueType, default Constant)
- BitmaskAttribute (FName, default "Mask", conditional, PCG_Overridable)
- Bitmask (int64, default 0, conditional, PCG_Overridable)
- Compositions (TArray<FPCGExBitmaskRef>)
- bInvertResult (bool, default false, PCG_Overridable)
Inherited Properties: From UPCGExFilterProviderSettings
Classes:
- UPCGExBitmaskFilterFactory
- UPCGExBitmaskFilterProviderSettings (display: "Filter : Bitmask")
Namespace: PCGExPointFilter::FBitmaskFilter
-->
