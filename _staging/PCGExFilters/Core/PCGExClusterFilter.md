---
icon: filter
description: 'Cluster Filter Definition - Base classes for filters that operate on graph clusters (vertices and edges).'
---
...
> See [Filter Definition](./PCGExPointFilter.md) for base filter settings.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Core/PCGExClusterFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Core/PCGExClusterFilter.h -->
...
Classes Documented:
- UPCGExClusterFilterFactoryData (abstract base for cluster filters)
- UPCGExClusterFilterProviderSettings (abstract provider base)
- UPCGExNodeFilterFactoryData (vertex/node filter factory)
- UPCGExVtxFilterProviderSettings (vertex filter provider)
- UPCGExEdgeFilterFactoryData (edge filter factory)
- UPCGExEdgeFilterProviderSettings (edge filter provider)
Data Types:
- FPCGExDataTypeInfoFilterCluster
- FPCGExDataTypeInfoFilterVtx
- FPCGExDataTypeInfoFilterEdge
Namespace Classes: IFilter, IVtxFilter, IEdgeFilter, FManager
-->
