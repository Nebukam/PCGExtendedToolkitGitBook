---
icon: filter
description: 'Point Filter Definition - Base factory data classes for all point filters.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFilters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Core/PCGExPointFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFilters/Public/Core/PCGExPointFilter.h -->
...
- UPCGExFilterCollectionFactoryData (collection filters)
Data Types:
- FPCGExDataTypeInfoFilter
- FPCGExDataTypeInfoFilterPoint
- FPCGExDataTypeInfoFilterCollection
Namespace Classes:
- PCGExPointFilter::IFilter (base filter interface)
- PCGExPointFilter::ISimpleFilter (simplified filter)
- PCGExPointFilter::ICollectionFilter (collection filter)
- PCGExPointFilter::FManager (filter manager)
Namespace Functions:
- RegisterBuffersDependencies
- PruneForDirectEvaluation
-->
