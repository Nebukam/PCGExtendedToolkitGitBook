...
description: 'Clipper2 : Offset - Expands or contracts paths by a specified distance'
---
...
|----------|------|-------------|
| **Method** | enum | Projection method (Normal, Custom) |
| **Projection Vector** | vector | Direction for projection plane normal |
...
📋 *Visible when Skip Open Paths is disabled*
...
📋 *Visible when Write Iteration is enabled*
...
📋 *Visible when Tag Iteration is enabled*
...
📋 *Visible when Tag Dual is enabled*
...
→ See [Clipper2 Processor Settings](../Core/PCGExClipper2Processor.md) for: Precision, Simplify Paths, Preserve Collinear, Arc Tolerance, Carry Over Details, Blending Details, Open Paths Output, Data Matching, and other shared settings.
...
📦 **Module**: `PCGExElementsClipper2` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClipper2/Public/Elements/PCGExClipper2Offset.h)
...
Nested Types: FPCGExGeo2DProjectionDetails, FPCGExInputShorthandNameInteger32Abs, EPCGExClipper2OffsetIterationCount, FPCGExInputShorthandSelectorDouble, EPCGExClipper2JoinType, EPCGExClipper2EndType
-->
