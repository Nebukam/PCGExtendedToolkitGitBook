---
icon: puzzle-piece
description: 'Clipper2 Processor - Base settings for Clipper2 boolean and offset operations'
---

# Clipper2 Processor (Base Class)
...
| Property | Type | Description |
|----------|------|-------------|
| **Preserve Attributes Default Value** | bool | Keep default attribute values |
| **Attributes** | filter | Which attributes to carry over |
| **Data Domain to Elements** | bool | Convert data-level attributes to element-level |
| **Tags** | filter | Which tags to carry over |
| **Flatten Tag Value** | bool | Flatten hierarchical tag values |
...
| Property | Type | Description |
|----------|------|-------------|
| **Blending Filter** | enum | Which attributes to blend (All, Include, Exclude) |
| **Filtered Attributes** | array | Specific attributes for include/exclude filter |
| **Default Blending** | enum | Blending mode for unlisted attributes |
| **Properties Overrides** | struct | Per-property blending overrides |
| **Attributes Overrides** | map | Per-attribute blending mode overrides |

Default: Average for default, None for properties
...
📋 *Visible when Tag Holes is enabled*
...
📦 **Module**: `PCGExElementsClipper2` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClipper2/Public/Core/PCGExClipper2Processor.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 13 documented
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: In (Paths), Labels (Params)
Outputs: Out (Paths), Open Paths (Paths)
Nested Types: FPCGExMatchingDetails, FPCGExCarryOverDetails, FPCGExBlendingDetails, EPCGExClipper2OpenPathOutput, EPCGExClipper2JoinType, EPCGExClipper2EndType, EPCGExClipper2FillRule
-->
