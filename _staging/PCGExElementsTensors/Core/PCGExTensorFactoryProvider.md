---
icon: puzzle-piece
description: 'Tensor Factory - Base factory for tensor field definitions.'
---
...
→ See [Factory Provider Settings](../../PCGExCore/Factories/PCGExFactoryProvider.md) for common factory options.
...
📦 **Module**: `PCGExElementsTensors` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Core/PCGExTensorFactoryProvider.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (Priority)
Inherited Properties: Referenced to UPCGExFactoryProviderSettings
Inputs: Varies by subclass
Outputs: Tensor (Tensor Factory)
Nested Types: FPCGExDataTypeInfoTensor
Note: This documents both UPCGExTensorFactoryData and UPCGExTensorFactoryProviderSettings as they form a provider pattern
-->
