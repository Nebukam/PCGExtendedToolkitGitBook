---
icon: filter
description: 'Filter : Tensor Dot - Compares dot value of a vector and tensors.'
---
...
→ See [Filter Factory](../../PCGExFilters/Core/PCGExFilterFactoryProvider.md) for common filter options like inversion.
...
📦 **Module**: `PCGExElementsTensors` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Filters/Points/PCGExTensorDotFilter.h)
...
Outputs: Filter (Filter Factory)
Nested Types: FPCGExTensorDotFilterConfig, FPCGExDotComparisonDetails, FPCGExTensorHandlerDetails
-->
