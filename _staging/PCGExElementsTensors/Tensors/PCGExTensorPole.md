---
icon: puzzle-piece
description: 'Tensor : Pole - A tensor that pulls and/or pushes.'
---
...
→ See [Tensor Factory](../Core/PCGExTensorFactoryProvider.md) for common tensor options including Weight, Potency, Falloff Curves, and Sampling Mutations.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTensors-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorPole.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorPole.h -->
...
Nested Types: FPCGExTensorPoleConfig
-->
