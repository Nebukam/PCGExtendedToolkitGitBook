---
icon: puzzle-piece
description: 'Tensor : Inertia (Constant) - A tensor constant that uses the seed transform.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTensors-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorInertiaConstant.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorInertiaConstant.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (Axis, Offset, TensorWeight, Potency, bSetInertiaOnce)
Inherited Properties: Referenced to UPCGExTensorFactoryProviderSettings
Inputs: None (no input points required)
Outputs: Tensor (Tensor Factory)
Nested Types: FPCGExTensorInertiaConstantConfig, EPCGExAxis
-->
