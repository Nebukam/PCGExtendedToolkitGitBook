---
icon: puzzle-piece
description: 'Tensor : Surface - A tensor that samples nearby surfaces to compute direction fields.'
---
...
📋 *Visible when Use World Collision is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTensors-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorSurface.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorSurface.h -->
...
Inputs: Actor References (Point Data), Surfaces (Surface Data)
Outputs: Tensor (Tensor Factory)
Nested Types: FPCGExTensorSurfaceConfig, EPCGExSurfaceTensorMode, FPCGExCollisionDetails, EPCGExAxis
-->
