---
icon: puzzle-piece
description: 'Tensor : Noise - A tensor that uses 3D noises as direction.'
---
...
→ See [Tensor Factory](../Core/PCGExTensorFactoryProvider.md) for common tensor options.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTensors-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorNoise.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Tensors/PCGExTensorNoise.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 4 documented (TensorWeight, Potency, bNormalizeNoiseSampling, Mutations)
Inherited Properties: Referenced to UPCGExTensorFactoryProviderSettings
Inputs: Noise (Noise Factory), Noise Mask (Noise Factory - optional)
Outputs: Tensor (Tensor Factory)
Nested Types: FPCGExTensorNoiseConfig, FPCGExTensorSamplingMutationsDetails
-->
