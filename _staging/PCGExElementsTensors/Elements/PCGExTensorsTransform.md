...
description: 'Tensors Transform - Transform input points using tensors.'
---
...
📋 *Visible when Write Effectors Pings is enabled*
...
📋 *Visible when Write Update Count is enabled*
...
📋 *Visible when Write Traveled Distance is enabled*
...
📋 *Visible when Write Gracefully Stopped is enabled*
...
📋 *Visible when Write Max Iterations Reached is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsTensors-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Elements/PCGExTensorsTransform.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsTensors/Public/Elements/PCGExTensorsTransform.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 17 documented
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (Point Data), Tensors (Tensor Factories), Stop Filters (Filter Factories)
Outputs: Out (Point Data)
Nested Types: EPCGExTensorTransformMode, EPCGExAxis, EPCGExTensorStopConditionHandling, FPCGExTensorHandlerDetails
-->
