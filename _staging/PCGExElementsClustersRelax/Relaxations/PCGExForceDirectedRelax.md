---
icon: puzzle-piece
description: 'Force Directed - Classic force-directed graph layout using spring attraction and electrostatic repulsion'
---

# Force Directed

Classic force-directed graph layout algorithm using spring attraction between connected vertices and electrostatic repulsion between all vertices.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Relax/PCGExForceDirectedRelax.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Relax/PCGExForceDirectedRelax.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 2 documented (SpringConstant, ElectrostaticConstant)
