---
icon: puzzle-piece
description: 'Box Fitting - Relaxes cluster vertices by resolving axis-aligned bounding box overlaps'
---

# Box Fitting

Relaxes cluster vertices by detecting and resolving overlaps between their axis-aligned bounding boxes.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Relax/PCGExBoxFittingRelax.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Relax/PCGExBoxFittingRelax.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (Padding)
