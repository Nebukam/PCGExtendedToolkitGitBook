---
icon: puzzle-piece
description: 'Fitting Relax Base - Base class for physics-based fitting relaxation operations'
---
...
📋 *Visible when Edge Fitting = Existing or Attribute*
...
📋 *Visible when Edge Fitting is not Ignore*
...
- [Box Fitting](./PCGExBoxFittingRelax.md) - Uses axis-aligned bounding boxes
- [Box Fitting v2](./PCGExBoxFittingRelax2.md) - Advanced box fitting with configurable extents
- [Radius Fitting](./PCGExRadiusFittingRelax.md) - Uses spherical collision detection

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Relax/PCGExFittingRelaxBase.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Relax/PCGExFittingRelaxBase.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 7 documented
Inherited Properties: From UPCGExRelaxClusterOperation
Inputs: N/A (abstract base class)
Outputs: N/A (abstract base class)
Nested Types: EPCGExRelaxEdgeFitting
-->
