...
description: 'Normalize - Output normalized position against data bounds to a new vector attribute.'
---
...
📋 *Visible when Transform Input = Constant*
...
📦 **Module**: `PCGExElementsSpatial` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/PCGExNormalize.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 8 documented
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (Point Data), Bounds (optional Point Data)
Outputs: Out (Point Data)
Nested Types: EPCGExOptionState, EPCGExPointBoundsSource, EPCGExIndexSafety, EPCGExInputValueType
-->
