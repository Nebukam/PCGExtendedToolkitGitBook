...
description: 'Bounds Axis To Points - Generate a two-point line from a bound axis'
---
...
📋 *Visible when Direction Constraint is not None*
...
📋 *Visible when Size Constraint is not None*
...
📋 *Visible when both Direction Constraint and Size Constraint are not None*
...
📋 *Visible when Set Extents is enabled*
...
📋 *Visible when Set Scale is enabled*
...
📋 *Visible when Generate Per Point Data is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSpatial-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/Bounds/PCGExBoundsAxisToPoints.h)
...
Inputs: In (inherited)
Outputs: Out
Nested Types: EPCGExPointBoundsSource, EPCGExBoundAxisPriority, EPCGExAxisDirectionConstraint, EPCGExAxisSizeConstraint, EPCGExAxisConstraintSorting, FPCGExAttributeToTagDetails
-->
