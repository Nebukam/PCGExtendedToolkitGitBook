...
description: 'Best Match Axis - Rotate points to match a direction while preserving orthogonality'
---
...
📋 *Visible when Mode is not ClosestTarget*
...
📋 *Visible when Mode is not ClosestTarget and Match Input = Attribute*
...
📋 *Visible when Mode is not ClosestTarget and Match Input = Constant*
...
📋 *Visible when Mode = Look at Closest Target*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSpatial-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/Bounds/PCGExBestMatchAxis.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/Bounds/PCGExBestMatchAxis.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 6 documented (Mode, MatchInput, MatchSource, MatchConstant, DataMatching, DistanceDetails)
Inherited Properties: UPCGExPointsProcessorSettings (standard points processor)
Inputs: In, Labels
Outputs: Out
Nested Types: EPCGExBestMatchAxisTargetMode, FPCGExMatchingDetails, FPCGExDistanceDetails
-->
