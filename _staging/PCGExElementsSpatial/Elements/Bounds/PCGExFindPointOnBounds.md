---
icon: crosshairs
description: 'Find Point on Bounds - Find the closest point to a position on the dataset bounds'
---
...
📋 *Visible when Best Fit Bounds is enabled*
...
📋 *Visible when UVW Input = Attribute*
...
📋 *Visible when UVW Input = Constant*
...
📦 **Module**: `PCGExElementsSpatial` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/Bounds/PCGExFindPointOnBounds.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 8 documented (OutputMode, bBestFitBounds, AxisOrder, UVWInput, LocalUVW, UVW, Offset, CarryOverDetails, bQuietAttributeMismatchWarning)
Inherited Properties: UPCGExPointsProcessorSettings (standard points processor)
Inputs: In (inherited)
Outputs: Out
Nested Types: EPCGExPointOnBoundsOutputMode, EPCGExAxisOrder, EPCGExInputValueType, FPCGExCarryOverDetails
-->
