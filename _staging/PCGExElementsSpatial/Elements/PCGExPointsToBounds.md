...
description: 'Points to Bounds - Merge points group to a single point representing their bounds.'
---
...
📋 *Visible when Output Oriented Bounding Box is enabled*
...
📋 *Visible when Blend Properties is enabled*
...
📋 *Visible when Write Points Count is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSpatial-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/PCGExPointsToBounds.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSpatial/Public/Elements/PCGExPointsToBounds.h -->
...
Nested Types: EPCGExOptionState, EPCGExAxisOrder, EPCGExPointBoundsSource, EPCGExPointsToBoundsOutputMode, FPCGExBlendingDetails, FPCGExPointsToBoundsDataDetails
-->
