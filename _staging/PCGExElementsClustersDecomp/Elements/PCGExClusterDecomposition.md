...
description: 'Cluster : Decomposition - Decompose clusters into cells and write a CellID attribute'
---
...
| Option | Method |
|--------|--------|
| **[BSP Occupancy](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompBSPOccupancy.md)** | Voxel grid with recursive axis-aligned BSP splits through empty space |
| **[Convex BSP](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompConvexBSP.md)** | Recursive PCA bisection until each cell is convex enough |
| **[Grid Partition](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompGridPartition.md)** | Uniform 3D grid quantization with small-cell merging |
| **[Max Boxes](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompMaxBoxes.md)** | Iterative largest axis-aligned box extraction |
| **[Max Boxes (Extended)](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompMaxBoxesExt.md)** | Max Boxes with weights, axis bias, volume preference, and heuristic merge gating |
| **[Spectral](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompSpectral.md)** | Graph Laplacian Fiedler vector bisection (topology-aware) |
| **[Threshold](../../PCGExElementsClustersDecomp/Decompositions/PCGExDecompThreshold.md)** | Bins a numeric attribute into value ranges |
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 4 documented (Decomposition, HeuristicScoreMode, CellIDAttributeName, CellCountAttributeName)
Inherited Properties: Referenced to UPCGExClustersProcessorSettings
Inputs: Vtx, Edges, Heuristics (factory, conditional), Overrides : Decomposition (param)
Outputs: Vtx, Edges
Instanced Factories: UPCGExDecompositionInstancedFactory (7 concrete types)
-->
