---
icon: puzzle-piece
description: 'Decompose : Max Boxes - Partition clusters by extracting largest axis-aligned boxes'
---
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 7 documented (TransformSpace, CustomTransform, VoxelSizeMode, VoxelSize, MaxCellSize, MinVoxelsPerCell, Balance)
