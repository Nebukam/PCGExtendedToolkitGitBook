---
icon: puzzle-piece
description: 'Decompose : Threshold - Partition clusters by binning a numeric attribute'
---
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented (AttributeSelector, NumBins, BinningMode)
Inherited Properties: Referenced to UPCGExDecompositionInstancedFactory
Inputs: N/A (sub-node)
Outputs: N/A (sub-node)
Nested Types: EPCGExDecompBinningMode
-->
