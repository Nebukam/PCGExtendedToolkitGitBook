---
icon: puzzle-piece
description: 'Decompose : Spectral - Partition clusters using graph Laplacian spectral bisection'
---
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented (NumPartitions, MaxIterations, ConvergenceTolerance)
Inherited Properties: Referenced to UPCGExDecompositionInstancedFactory
Inputs: N/A (sub-node, requires heuristics via parent)
