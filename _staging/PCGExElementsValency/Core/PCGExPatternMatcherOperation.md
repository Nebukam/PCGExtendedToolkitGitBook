---
icon: puzzle-piece
description: 'Pattern Matcher Factory - Base factory for valency pattern matching operations'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsValency-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsValency/Public/Core/PCGExPatternMatcherOperation.h)
...
Inputs: N/A (abstract factory)
Outputs: N/A (abstract factory)
Nested Types: EPCGExPatternOverlapResolution (documented in source, not exposed as property)
-->
