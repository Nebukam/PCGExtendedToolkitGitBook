---
icon: cog
description: 'Orbital Set - Data asset defining directional orbitals for a valency layer'
---
...
Nested Types: FPCGExValencyOrbitalEntry (documented inline), FOrbitalDirectionResolver (internal runtime cache)
-->
