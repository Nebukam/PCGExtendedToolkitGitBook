---
icon: puzzle-piece
description: 'Picker : Ranges from Set - A Picker that accepts lists of ranges in the form of FVector2, read from one or more attributes.'
---
...
→ See [Picker Factory Provider](../Core/PCGExPickerFactoryProvider.md) for: Treat As Normalized, Truncate Mode, Safety, and other shared picker properties.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExPickers-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExPickers/Public/Pickers/PCGExPickerAttributeSetRanges.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExPickers/Public/Pickers/PCGExPickerAttributeSetRanges.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (Attributes array)
Inherited Properties: Referenced to Picker Factory Provider
Inputs: Ranges (Point Data with FVector2 attributes)
Outputs: Picker (Picker factory)
Nested Types: FPCGExPickerAttributeSetRangesConfig
Special Features: Range expansion, negative index support, overlapping range deduplication, multi-attribute aggregation
-->
