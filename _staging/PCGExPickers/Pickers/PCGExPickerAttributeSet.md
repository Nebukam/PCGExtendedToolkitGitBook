---
icon: puzzle-piece
description: 'Picker : Indices from Set - A Picker that accepts lists of values, read from one or more attributes.'
---

# Picker : Indices from Set

A Picker that accepts lists of values, read from one or more attributes.
...
📦 **Module**: `PCGExPickers` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExPickers/Public/Pickers/PCGExPickerAttributeSet.h)
...
Nested Types: FPCGExPickerAttributeSetConfig
Special Features: Negative index support, multi-attribute aggregation, auto-fallback to first attribute
-->
