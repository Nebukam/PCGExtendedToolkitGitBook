---
icon: puzzle-piece
description: 'Picker : Range - A Picker that selects a range of values.'
---
...
Inputs: None (constant range configured in settings)
Outputs: Picker (Picker factory)
Nested Types: FPCGExPickerConstantRangeConfig
Special Features: Negative index support, auto-swap if start > end, range expansion, discrete/normalized modes
-->
