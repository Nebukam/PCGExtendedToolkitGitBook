---
icon: puzzle-piece
description: 'Picker : Constant - A Picker that has a single value.'
---
...
📋 *Visible when Treat As Normalized is disabled*
...
📋 *Visible when Treat As Normalized is enabled*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExPickers-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExPickers/Public/Pickers/PCGExPickerConstant.h)
...
Inputs: None (constant value configured in settings)
Outputs: Picker (Picker factory)
Nested Types: FPCGExPickerConstantConfig
Special Features: Negative index support, discrete/normalized modes, simplest picker type
-->
