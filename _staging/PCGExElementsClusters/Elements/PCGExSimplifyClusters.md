...
description: 'Cluster : Simplify - Simplifies cluster topology by removing redundant vertices from chains'
---
...
📋 *Visible when Merge Above Angular Threshold is enabled*
...
When enabled, removes vertices at sharp angles instead of collinear ones — vertices are removed when the angle is *above* the threshold rather than below.
...
📋 *Visible when Merge Above Angular Threshold and Fuse Collocated are enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExSimplifyClusters.h)
...
Inherited Properties: Referenced via shared type documentation
Inputs: Vtx, Edges, Keep Conditions, Edge Filters
Outputs: Vtx, Edges
Nested Types: EPCGExSimplifyClusterEdgeFilterRole, FPCGExEdgeUnionMetadataDetails
-->
