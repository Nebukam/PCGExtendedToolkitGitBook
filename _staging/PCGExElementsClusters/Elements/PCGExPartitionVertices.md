---
icon: table-columns
description: 'Cluster : Partition Vtx - Split vertices into per-cluster groups'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExPartitionVertices.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExPartitionVertices.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: None (utility node)
