---
icon: puzzle-piece
description: 'Sampler : Test Neighbors - Count neighbors passing filters'
---
...
→ See [Neighbor Sampler Base](./PCGExNeighborSampleFactoryProvider.md) for: Priority, Max Depth, Blend Over, Weight Curve, etc.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/NeighborSamplers/PCGExNeighborSampleFilters.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/NeighborSamplers/PCGExNeighborSampleFilters.h -->
...
Inherited Properties: UPCGExNeighborSampleProviderSettings base (FPCGExSamplingConfig)
Inputs: Vtx Filters, Edge Filters (filter factories)
Outputs: Out (sampler factory)
Factory Type: UPCGExNeighborSamplerFactoryFilters → UPCGExNeighborSamplerFactoryData
-->
