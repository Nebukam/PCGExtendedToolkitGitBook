---
icon: puzzle-piece
description: 'Vtx : Special Edges - Outputs data about a vertex''s shortest, longest, and average edges'
---
...
See [Vtx Property Provider](./PCGExVtxPropertyFactoryProvider.md) for base class information.

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/VtxProperties/PCGExVtxPropertySpecialEdges.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/VtxProperties/PCGExVtxPropertySpecialEdges.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (Config with 3 sub-settings)
Inherited Properties: Referenced to UPCGExVtxPropertyProviderSettings
Inputs: SourcePointFilters, Labels (inherited)
Outputs: Property (factory data)
Nested Types: FPCGExSpecialEdgesConfig, FPCGExEdgeOutputWithIndexSettings, FPCGExSimpleEdgeOutputSettings
-->
