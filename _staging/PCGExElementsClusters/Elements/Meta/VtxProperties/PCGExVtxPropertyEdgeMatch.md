---
icon: puzzle-piece
description: 'Vtx : Edge Match - Find the edge matching a specified direction'
---
...
→ See [Dot Comparison Details](../../../../_shared/FPCGExDotComparisonDetails.md)
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/VtxProperties/PCGExVtxPropertyEdgeMatch.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/VtxProperties/PCGExVtxPropertyEdgeMatch.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 8 documented from FPCGExEdgeMatchConfig (Origin, DirectionInput, Direction, bInvertDirection, DirectionConstant, bTransformDirection, DotComparisonDetails, MatchingEdge)
Inherited Properties: UPCGExVtxPropertyProviderSettings base
Nested Types: EPCGExAdjacencyDirectionOrigin, EPCGExInputValueType, FPCGExDotComparisonDetails, FPCGExEdgeOutputWithIndexSettings
Factory Type: UPCGExVtxPropertyEdgeMatchFactory → UPCGExVtxPropertyFactoryData
-->
