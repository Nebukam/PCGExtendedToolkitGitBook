---
icon: puzzle-piece
description: 'Vtx : Amplitude - Compute vertex amplitude from neighboring connections'
---
...
📋 *Visible when Write Min Amplitude = true and Min Mode = Individual*
...
📋 *Visible when Write Max Amplitude = true and Max Mode = Individual*
...
📋 *Visible when Write Amplitude Range = true and Range Mode = Individual*
...
📋 *Visible when Write Amplitude Sign = true, Up Mode = Custom Up Vector, and Up Input Type ≠ Constant*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/VtxProperties/PCGExVtxPropertyAmplitude.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/VtxProperties/PCGExVtxPropertyAmplitude.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 20 documented from FPCGExAmplitudeConfig (min/max/range/sign amplitude outputs with modes and options)
Inherited Properties: UPCGExVtxPropertyProviderSettings base
Nested Types: EPCGExVtxAmplitudeMode, EPCGExVtxAmplitudeUpMode, EPCGExVtxAmplitudeSignOutput, EPCGExInputValueType
Factory Type: UPCGExVtxPropertyAmplitudeFactory → UPCGExVtxPropertyFactoryData
-->
