---
icon: cog
description: 'Cluster : Edge Properties - Extract and write edge information to edge points'
---
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Meta/PCGExWriteEdgeProperties.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 25+ documented
Inherited Properties: Referenced to UPCGExClustersProcessorSettings
Inputs: Vtx, Edges, Heuristics (optional)
Outputs: Vtx, Edges
-->
