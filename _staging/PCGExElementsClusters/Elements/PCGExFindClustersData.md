...
description: 'Find Clusters - Find vtx/edge pairs inside a soup of data collections'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExFindClustersData.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExFindClustersData.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (mixed point collections)
Outputs: Vtx, Edges
-->
