...
description: 'Cluster : Edge Order - Fix order for edge start and end endpoints'
---
...
*Visible when Direction Method = EndpointsAttribute*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExEdgeOrder.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExEdgeOrder.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 struct documented (3 inner properties)
