---
icon: route
description: 'Cluster : Break to Paths - Create individual paths from continuous edge chains'
---
...
*Visible when Winding is not Unchanged*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Paths/PCGExBreakClustersToPaths.h)
...
Inputs: Vtx, Edges, Break Conditions (optional)
Outputs: Paths
-->
