---
icon: crosshairs
description: 'Sample : Vtx by ID - Sample a cluster vtx by using a stored Vtx ID.'
---
...
📋 *Visible when Use Up from... = Constant*
...
📋 *Visible when Tag If Has Successes = true*
...
📋 *Visible when Tag If Has No Successes = true*
...
> See [Points Processor Settings](../Shared/PointsProcessorSettings.md) for: Point filters and other common configuration.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/PCGExSampleVtxByID.h)
...
Inputs: In, Vtx, Blenders
Outputs: Out
Nested Types: FPCGExApplySamplingDetails, EPCGExAxisAlign, EPCGExInputValueType
-->
