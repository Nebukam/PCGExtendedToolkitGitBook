---
icon: cog
description: 'Cluster : Write States - Writes cluster states as an int64 flag mask attribute'
---

# Cluster : Write States

Writes cluster states as an int64 flag mask attribute on vertices.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/States/PCGExClusterWriteStates.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/States/PCGExClusterWriteStates.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 2 documented (FlagAttribute, InitialFlags)
Inherited Properties: From UPCGExClustersProcessorSettings
Inputs: Vtx, Edges, States
Outputs: Vtx, Edges
Nested Types: None
-->
