---
icon: puzzle-piece
description: 'State : Bitmask Adjacency - Applies bitmask operations based on directional adjacency checks'
---
...
📋 *Visible when Use Alternative Bitmasks On Filter Fail is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/States/PCGExAdjacencyStates.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/States/PCGExAdjacencyStates.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 8 documented
Inherited Properties: From UPCGExStateFactoryProviderSettings
Inputs: Filters (optional)
Outputs: State (factory data)
Nested Types: FPCGExAdjacencyStateConfigBase
-->
