---
icon: filter
description: 'Vtx Filter : Adjacency - Filters vertices by comparing attribute values with their neighbors'
---
...
📋 *Visible when Mode = Some, Threshold Type = Discrete, Threshold Input = Constant*
...
📋 *Visible when Mode = Some, Threshold Type = Relative, Threshold Input = Constant*
...
📋 *Visible when Threshold Type = Relative*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Filters/Nodes/PCGExNodeAdjacencyFilter.h)
...
Nested Types: FPCGExNodeAdjacencyFilterConfig, FPCGExAdjacencySettings
-->
