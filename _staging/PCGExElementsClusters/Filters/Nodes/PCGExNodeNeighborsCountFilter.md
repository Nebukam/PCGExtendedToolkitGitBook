---
icon: filter
description: 'Vtx Filter : Num Edges - Filters vertices based on their number of connected edges'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Filters/Nodes/PCGExNodeNeighborsCountFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Filters/Nodes/PCGExNodeNeighborsCountFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (via FPCGExNodeNeighborsCountFilterConfig)
Inherited Properties: From UPCGExVtxFilterProviderSettings
Inputs: None
Outputs: Vtx Filter (factory data)
Nested Types: FPCGExNodeNeighborsCountFilterConfig
-->
