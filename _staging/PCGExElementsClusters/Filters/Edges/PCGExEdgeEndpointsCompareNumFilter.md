---
icon: filter
description: 'Edge Filter : Endpoints Compare (Numeric) - Filters edges by comparing numeric attribute values between endpoints'
---

# Edge Filter : Endpoints Compare (Numeric)

Filters edges by comparing a numeric attribute value between the edge's start and end vertices.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Filters/Edges/PCGExEdgeEndpointsCompareNumFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Filters/Edges/PCGExEdgeEndpointsCompareNumFilter.h -->
...
Nested Types: FPCGExEdgeEndpointsCompareNumFilterConfig
-->
