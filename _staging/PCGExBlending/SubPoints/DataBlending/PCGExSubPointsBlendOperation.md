---
icon: puzzle-piece
description: 'Sub-Point Blending Base - Base factory for sub-point attribute blending operations'
---

# Sub-Point Blending Base
...
📋 *Visible when Blending Filter = Include or Exclude*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExBlending-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExBlending/Public/SubPoints/DataBlending/PCGExSubPointsBlendOperation.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExBlending/Public/SubPoints/DataBlending/PCGExSubPointsBlendOperation.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (BlendingDetails with 5 inner properties via ShowOnlyInnerProperties)
Inherited Properties: None documented (abstract base class)
Inputs: N/A (instanced factory)
Outputs: N/A (instanced factory)
Nested Types: FPCGExBlendingDetails fully documented
-->
