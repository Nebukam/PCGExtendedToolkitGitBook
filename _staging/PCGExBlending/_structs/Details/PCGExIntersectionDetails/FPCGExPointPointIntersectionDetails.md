---
icon: circle-dot
description: 'Point Point Intersection Details - Configure point fusing and union behavior'
---

# Point Point Intersection Details
...
📋 *Visible when the operation supports edges (cluster fusing)*
...
Nested Types: FPCGExFuseDetails, FPCGExPointUnionMetadataDetails, FPCGExEdgeUnionMetadataDetails
Used By: Path To Clusters, Cluster Fuse, Fuse Points
-->
