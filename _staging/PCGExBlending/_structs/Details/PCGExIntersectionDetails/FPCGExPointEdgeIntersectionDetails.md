---
icon: arrows-to-dot
description: 'Point Edge Intersection Details - Configure point-to-edge intersection detection'
---

# Point Edge Intersection Details
...
![Static Badge](https://img.shields.io/badge/Source-PCGExBlending-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExBlending/Public/Details/PCGExIntersectionDetails.h)
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (bEnableSelfIntersection, FuseDetails, bSnapOnEdge, bWriteIsIntersector, IsIntersectorAttributeName)
Inherited Properties: None
Nested Types: FPCGExSourceFuseDetails
Used By: Path To Clusters, Cluster Fuse
-->
