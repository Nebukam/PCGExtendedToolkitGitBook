---
icon: blender
description: 'Blending Details - Configure how point attributes are blended together'
---
...
📋 *Visible when Blending Filter ≠ All*
...
📦 **Module**: `PCGExBlending` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExBlending/Public/Details/PCGExBlendingDetails.h)
...
Nested Types: EPCGExAttributeFilter, EPCGExBlendingType, FPCGExPointPropertyBlendingOverrides
Used By: 15+ nodes including Cell Diagram, Dual Graph, Fuse operations, Path operations
-->
