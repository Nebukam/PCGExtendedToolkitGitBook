---
icon: puzzle-piece
description: 'BlendOp - Creates a single blend operation for use with the Attribute Blender'
---
...
📋 *Visible when Use Operand B is enabled*
...
📋 *Visible when Output Mode = New or Transient*
...
📋 *Visible when Output Type = Custom*
...
📋 *Visible when Weight Input = Constant*
...
📋 *Visible when Weight Input = Attribute*
...
→ See [PCGExFactoryProviderSettings](../../Core/PCGExFactoryProviderSettings.md) for shared provider configuration.
...
📦 **Module**: `PCGExBlending` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExBlending/Public/Core/PCGExBlendOpFactoryProvider.h)
...
Inputs: Labels
Outputs: Blending
Nested Types: EPCGExABBlendingType, EPCGExBlendOpOutputMode, EPCGExOperandAuthority, EPCGExInputValueType, FPCGExAttributeBlendWeight, FPCGExAttributeBlendConfig
-->
