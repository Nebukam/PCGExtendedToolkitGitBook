---
icon: puzzle-piece
description: 'Blend Op Factory - Base factory class for creating blend operations'
---
...
→ See [PCGExFactoryData](../../Core/PCGExFactoryData.md) for factory lifecycle and registration settings.

---

📦 **Module**: `PCGExBlending` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExBlending/Public/Core/PCGExBlendOpFactory.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 0 documented (factory class has no UPROPERTY members)
Inherited Properties: Referenced to UPCGExFactoryData
Inputs: N/A (factory class)
Outputs: N/A (factory class)
Nested Types: FPCGExAttributeBlendWeight, FPCGExAttributeBlendConfig, FPCGExBlendOperation, FPCGExDataTypeInfoBlendOp
-->
