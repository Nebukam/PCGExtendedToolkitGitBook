---
icon: compress
description: 'Reduce Data - Aggregates @Data domain attributes across multiple collections'
---
...
📋 *Visible when Custom Output Type is enabled*
...
📦 **Module**: `PCGExElementsMeta` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExReduceDataAttribute.h)
...
Inputs: In (Any)
Outputs: Out (Any)
Nested Types: FPCGExAttributeSourceToTargetDetails, EPCGExReduceDataDomainMethod
-->
