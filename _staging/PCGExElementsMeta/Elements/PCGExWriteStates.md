---
icon: flag
description: 'Write States - Evaluates filter-based states and writes results as bitmask flags'
---
...
📋 *Visible when On Test Pass is enabled*
...
📋 *Visible when On Test Fail is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsMeta-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExWriteStates.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExWriteStates.h -->

<!-- VERIFICATION REPORT
Main Node (UPCGExWriteStatesSettings):
  Node-Specific Properties: 2 documented (FlagAttribute, InitialFlags)
  Inherited Properties: Referenced to UPCGExPointsProcessorSettings
  Inputs: In (Points), Labels (Params)
  Outputs: Out (Points)

Sub-Node (UPCGExPointStateFactoryProviderSettings):
  Node-Specific Properties: 5 documented (Name, Priority, bOutputBitmasks, Config.bOnTestPass/PassStateFlags, Config.bOnTestFail/FailStateFlags)
  Inputs: Filters (Params)
  Outputs: State (Params), BitmaskPass (Params), BitmaskFail (Params)

Nested Types: EPCGExBitOp, EPCGExBitmaskMode, FPCGExBitmaskWithOperation, FPCGExStateConfigBase
-->
