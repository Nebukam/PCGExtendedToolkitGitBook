---
icon: broom
description: 'Meta Cleanup - Keeps or removes tags and attributes using string queries'
---
...
| **Comma Separated Names** | string | Attribute names or patterns to match |
| **Match Mode** | enum | Equals, Contains, StartsWith, EndsWith |
| **Preserve PCGEx Data** | bool | Keep internal PCGEx attributes |
...
📦 **Module**: `PCGExElementsMeta` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExMetaCleanup.h)
...
Inputs: In (Points)
Outputs: Out (Points)
Nested Types: FPCGExCarryOverDetails, FPCGExNameFiltersDetails
-->
