---
icon: box-archive
description: 'Pack Actor Data - Extracts data from actor references using custom Blueprint logic'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsMeta-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExPackActorData.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExPackActorData.h -->

<!-- VERIFICATION REPORT
Main Node (UPCGExPackActorDataSettings):
  Node-Specific Properties: 6 documented
  Inherited Properties: Referenced to UPCGExPointsProcessorSettings
  Inputs: In (Points), Overrides (Params)
  Outputs: Out (Points)

Instanced Factory (UPCGExCustomActorDataPacker):
  Blueprintable abstract class with Initialize and ProcessEntry events
  Provides Init*, Write*, and Read* functions for various types
  Settings: bExecuteOnMainThread
-->
