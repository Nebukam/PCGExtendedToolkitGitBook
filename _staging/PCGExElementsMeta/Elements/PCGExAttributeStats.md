...
|----------|------|-------------|
| **Filter Mode** | enum | All, Include, or Exclude matching attributes |
| **Comma Separated Names** | string | Attribute names to match |
| **Filter Match Mode** | enum | Equals, Contains, StartsWith, EndsWith |
...
📦 **Module**: `PCGExElementsMeta` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExAttributeStats.h)
