---
icon: arrow-down-1-9
description: 'Sort Collections - Reorders collections based on @Data domain attributes'
---
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsMeta-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/Sorting/PCGExSortCollections.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (SortDirection)
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (Any), SortRules (Params)
Outputs: Out (Any)
Nested Types: EPCGExSortDirection
-->
