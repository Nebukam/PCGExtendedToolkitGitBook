...
description: 'Attribute Remap - Transforms attribute values through configurable remapping'
---
...
📋 *Visible when Override Component 2 is enabled*
...
📋 *Visible when Override Component 3 is enabled*
...
📋 *Visible when Override Component 4 is enabled*
...
📦 **Module**: `PCGExElementsMeta` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExAttributeRemap.h)
...
Inputs: In (Points)
Outputs: Out (Points)
Nested Types: FPCGExAttributeSourceToTargetDetails, FPCGExComponentRemapRule, FPCGExClampDetails, FPCGExRemapDetails
-->
