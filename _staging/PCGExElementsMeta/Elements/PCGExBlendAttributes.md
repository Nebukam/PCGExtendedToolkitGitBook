---
icon: blender
description: 'Uber Blend - Combines multiple blend operations in a single node'
---
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsMeta-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Elements/PCGExBlendAttributes.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 0 (none)
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (Points), Filters (Params), Blending (Params)
Outputs: Out (Points)
Nested Types: None
-->
