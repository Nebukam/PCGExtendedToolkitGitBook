---
icon: filter
description: 'Filter : Noise - Filters points by comparing spatial noise against a threshold'
---
...
→ See [Filter Settings](../../Core/PCGExFilter.md) for common filter settings (Invert, priority, etc.).
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsMeta-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Filters/Points/PCGExNoiseFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsMeta/Public/Filters/Points/PCGExNoiseFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (Comparison, Input, Constant, Attribute, Tolerance via FPCGExCompareSelectorDouble)
Inherited Properties: Referenced to filter base
Inputs: Noises (Params)
Outputs: Filter (Params)
Nested Types: FPCGExNoiseFilterConfig, FPCGExCompareSelectorDouble, EPCGExComparison, EPCGExInputValueType
-->
