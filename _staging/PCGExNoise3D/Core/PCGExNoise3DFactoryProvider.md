---
icon: cog
description: 'Noise3D Factory Provider - Core base classes for the 3D noise system.'
---

# Noise3D Factory Provider
...
📋 *Visible when Apply Transform is enabled*
...
Provider Properties: 1 documented (Priority)
Factory Classes: UPCGExNoise3DFactoryData, UPCGExNoise3DFactoryProviderSettings
Type: Core infrastructure/base classes
Purpose: Foundation for all noise implementations
-->
