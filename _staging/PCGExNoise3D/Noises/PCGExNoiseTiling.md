---
icon: puzzle-piece
description: 'Noise : Tiling - Tiling noise - seamlessly tileable patterns.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseTiling.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseTiling.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 6 documented (Octaves, Lacunarity, Persistence, PeriodX, PeriodY, PeriodZ)
Inherited Properties: Referenced to Noise3D Factory Provider
Inputs: None (noise generator)
Outputs: Noise3D (Noise factory)
Nested Types: FPCGExNoiseConfigTiling
Use Cases: tileable textures, seamless backgrounds, repeating material patterns, texture atlases, wrapping spaces
Special Features: Periodic hash wrapping, seamless tiling per axis, independent period control
Algorithm: Gradient noise with periodic boundary conditions
Technical: Modulo wrapping ensures continuity at tile boundaries
-->
