---
icon: puzzle-piece
description: 'Noise : Flow - Flow noise - time-coherent animated patterns.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseFlow.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseFlow.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (Octaves, Lacunarity, Persistence, Time, RotationSpeed)
Inherited Properties: Referenced to Noise3D Factory Provider
Inputs: None (noise generator)
Outputs: Noise3D (Noise factory)
Nested Types: FPCGExNoiseConfigFlow
Use Cases: animated clouds, flowing water, smoke, fire, wind effects, time-varying patterns
Special Features: Time-coherent animation, gradient rotation, per-cell rotation rates, flicker-free motion
-->
