---
icon: puzzle-piece
description: 'Noise : Spots - Spots noise - circular/shaped spot patterns.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseSpots.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseSpots.h -->
...
Nested Types: FPCGExNoiseConfigSpots, EPCGExSpotsShape (5 shapes)
Use Cases: polka dots, leopard spots, dalmatian patterns, cell structures, stylized textures, decorative patterns
Special Features: Cell-based placement, multiple shape options, jitter/variation, invertible
Pattern Type: Discrete/cellular (non-continuous), shaped regions
-->
