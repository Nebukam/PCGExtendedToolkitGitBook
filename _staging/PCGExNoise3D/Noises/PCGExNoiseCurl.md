---
icon: puzzle-piece
description: 'Noise : Curl - Curl noise - divergence-free for fluids and particles.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseCurl.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseCurl.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (Octaves, Lacunarity, Persistence, Epsilon, CurlScale)
Inherited Properties: Referenced to Noise3D Factory Provider
Inputs: None (noise generator)
Outputs: Noise3D (Noise factory)
Nested Types: FPCGExNoiseConfigCurl
Use Cases: fluid flow, particle advection, smoke simulation, cloud motion, swirling effects
Special Features: Divergence-free vector field, multi-octave layering, vector output support
Mathematical Property: ∇·F = 0 (divergence-free)
-->
