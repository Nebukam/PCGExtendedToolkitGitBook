---
icon: puzzle-piece
description: 'Noise : Perlin - Classic Perlin gradient noise.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoisePerlin.h)
...
Nested Types: FPCGExNoiseConfigPerlin
Use Cases: general-purpose noise, terrain, textures, clouds, classic procedural effects
Special Features: Classic gradient noise, well-understood behavior, widely used
Algorithm: Classic Perlin noise (1983)
Historical Note: Original gradient noise algorithm by Ken Perlin
-->
