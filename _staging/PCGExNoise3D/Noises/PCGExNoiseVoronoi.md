---
icon: puzzle-piece
description: 'Noise : Voronoi - Voronoi noise - cell patterns with multiple modes.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseVoronoi.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseVoronoi.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented (OutputType, Jitter, Smoothness)
Inherited Properties: Referenced to Noise3D Factory Provider
Inputs: None (noise generator)
Outputs: Noise3D (Noise factory)
Nested Types: FPCGExNoiseConfigVoronoi, EPCGExVoronoiOutput (4 output modes)
Use Cases: cellular textures, stone patterns, cracked surfaces, organic partitions, terrain features, cell-based effects
Special Features: Multiple output modes, jitter control, smooth blending, Voronoi diagram based
Algorithm: Voronoi/Worley noise with F1/F2 distance calculations
Output Modes: Cell Value (flat), Distance to Center (radial), Edge Distance (boundaries), Crackle (F2-F1)
Technical: Smooth minimum function for cell blending
-->
