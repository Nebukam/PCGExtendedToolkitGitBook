---
icon: puzzle-piece
description: 'Noise : Marble - Marble noise - veined patterns with turbulence.'
---
...
![Static Badge](https://img.shields.io/badge/Module-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseMarble.h)
...
Nested Types: FPCGExNoiseConfigMarble, EPCGExMarbleDirection (4 directions)
Use Cases: marble textures, wood grain, geological patterns, stylized effects
Special Features: Sine-based veins, turbulence distortion, multiple direction modes including radial
Mathematical Basis: Distorted sine function with multi-octave turbulence
-->
