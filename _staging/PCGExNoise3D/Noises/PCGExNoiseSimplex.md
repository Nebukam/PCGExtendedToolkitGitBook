---
icon: puzzle-piece
description: 'Noise : Simplex - Simplex gradient noise - efficient, high quality.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExNoise3D-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseSimplex.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseSimplex.h -->
...
Nested Types: FPCGExNoiseConfigSimplex
Use Cases: general-purpose noise, terrain, textures, performance-critical procedural effects
Special Features: Efficient computation, simplex geometry, fewer gradient evaluations than Perlin
Algorithm: Simplex noise by Ken Perlin (improved over Perlin noise)
Historical Note: Patent concerns (expired 2022), led to creation of OpenSimplex2
Performance: Faster than classic Perlin due to simplex grid structure
-->
