---
icon: puzzle-piece
description: 'Noise : FBM - Fractal Brownian Motion with variants (ridged, billow, warped).'
---
...
📋 *Visible when Variant = Ridged Multifractal*
...
📋 *Visible when Variant = Domain Warped*
...
📦 **Module**: `PCGExNoise3D` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseFBM.h)
...
Nested Types: FPCGExNoiseConfigFBM, EPCGExFBMVariant (5 variants)
Use Cases: terrain generation, cloud simulation, organic textures, procedural surfaces
Special Features: 5 variants, multi-octave layering, self-similar fractal properties
-->
