---
icon: puzzle-piece
description: 'Noise : Swiss (Erosion) - Swiss noise - terrain with natural erosion patterns.'
---
...
📦 **Module**: `PCGExNoise3D` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExNoise3D/Public/Noises/PCGExNoiseSwiss.h)
...
Nested Types: FPCGExNoiseConfigSwiss
Use Cases: terrain generation, canyon systems, eroded landscapes, geological features, cliff formations
Special Features: Analytical derivatives, derivative-based warping, erosion simulation, ridge formation
Algorithm: Derivative-based fractal noise (Swiss turbulence)
Technical: Uses slope information to create feedback erosion, custom fractal accumulation
Default Octaves: 6 (higher than typical to showcase erosion patterns)
-->
