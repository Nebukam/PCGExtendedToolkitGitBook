...
📦 **Module**: `PCGExCollectionsEditor` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExCollectionsEditor/Public/PCGExCollectionsEditorSettings.h)
