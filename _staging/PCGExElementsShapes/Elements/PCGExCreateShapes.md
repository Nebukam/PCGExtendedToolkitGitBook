---
icon: shapes
description: 'Create Shapes - Use shape builders to create shapes from input seed points'
---
...
| **Point Filters** | Params | *Optional.* Filters to select which seed points generate shapes |
...
📋 *Visible when Output Mode = Per Shape*
...
📋 *Visible when Remove Below is enabled*
...
📋 *Visible when Remove Above is enabled*
...
→ See [Shape Processor](../Core/PCGExShapeProcessor.md) for: Output Mode
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsShapes-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsShapes/Public/Elements/PCGExCreateShapes.h)
...
Inherited Properties: Referenced to UPCGExShapeProcessorSettings (OutputMode)
Inputs: In (Points), Shape Builders (Shape), Point Filters (Params)
Outputs: Out (Points)
Nested Types: EPCGExShapeOutputMode (inherited)
-->
