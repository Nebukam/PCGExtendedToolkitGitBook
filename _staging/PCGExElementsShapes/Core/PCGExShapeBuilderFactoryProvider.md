---
icon: shapes
description: 'Shape Builder Definition - Base factory for shape generation'
---

# Shape Builder Definition
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsShapes-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsShapes/Public/Core/PCGExShapeBuilderFactoryProvider.h)
...
<!-- VERIFICATION REPORT
Abstract Classes:
  - UPCGExShapeBuilderFactoryData (factory data base)
  - UPCGExShapeBuilderFactoryProviderSettings (provider base)
Node-Specific Properties: None (abstract base)
Output Type: FPCGExDataTypeInfoShape
Concrete Implementations: Circle, Grid, Polygon, Fiblat
-->
