---
icon: grid
description: 'Shape : 3D Grid - Creates points in a 3D grid pattern'
---
...
Node-Specific Properties (Grid): 7
  - AdjustFit (bitmask)
  - TruncateX, AxisClampDetailsX
  - TruncateY, AxisClampDetailsY
  - TruncateZ, AxisClampDetailsZ
...
Nested Types: EPCGExTruncateMode, FPCGExClampDetails
-->
