---
icon: list-ol
description: 'Match : By Index - Matches elements based on index positions.'
---
...
**Tile Example**: Index 7 in array of 5 → 7 % 5 = 2
**Clamp Example**: Index 7 in array of 5 → min(7, 4) = 4
**Yoyo Example**: Index 7 in array of 5 → bounces to 1
...
![Static Badge](https://img.shields.io/badge/Source-PCGExMatching-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchByIndex.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchByIndex.h -->
...
Nested Types: FPCGExMatchByIndexConfig, EPCGExMatchByIndexSource (2 modes)
Use Cases: sequential pairing, ordered correspondences, array-like matching, indexed lookups, synchronized datasets
Special Features: Bidirectional index lookup, safety handling for out-of-bounds, attribute-based indexing
Safety Modes: Ignore, Clamp, Tile, Yoyo
Technical: Index attribute reading, modulo wrapping, boundary handling
-->
