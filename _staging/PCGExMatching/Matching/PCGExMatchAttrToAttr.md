---
icon: equals
description: 'Match : Attributes - Compares attribute values between datasets.'
---
...
- **Default (DBL_COMPARE_TOLERANCE)**: Standard floating-point tolerance
...
![Static Badge](https://img.shields.io/badge/Source-PCGExMatching-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchAttrToAttr.h)
...
Nested Types: FPCGExMatchAttrToAttrConfig
Use Cases: key-based matching, ID correspondence, category filtering, value-based pairing, database joins
Special Features: Numeric and string comparison modes, tolerance for floating-point, operand swapping
Comparison Types: Multiple numeric operators, multiple string operators
Technical: Attribute broadcasting, type casting, data/point domain support
-->
