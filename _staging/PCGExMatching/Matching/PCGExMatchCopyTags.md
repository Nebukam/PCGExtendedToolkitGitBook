---
icon: copy
description: 'Match : Copy Tags - Copies tags from matched targets to candidates.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExMatching-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchCopyTags.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchCopyTags.h -->
...
Nested Types: FPCGExMatchCopyTagsConfig (inherits from base, adds no properties)
Use Cases: tag propagation, metadata inheritance, classification transfer, attribute enrichment
Special Features: Side-effect matching (modifies data), tag accumulation, preserves original tags
Behavior: Copies all tags from target to candidate on match
Technical: Tag copying during match evaluation
-->
