---
icon: tags
description: 'Match : Shared Tag - Matches based on shared tags between datasets.'
---
...
**Specific**: Precise control, single tag check
**Any Shared**: Flexible, finds any common metadata
**All Shared**: Strict, ensures complete tag subset relationship
...
- `"Region_North"`: Checks for tag named "Region_North"
...
→ See [Match Rule Factory Provider](../Core/PCGExMatchRuleFactoryProvider.md) for: Strictness, Invert
...
![Static Badge](https://img.shields.io/badge/Source-PCGExMatching-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchSharedTag.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchSharedTag.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 6 documented (Mode, TagNameInput, TagNameAttribute, TagName, bDoValueMatch, bMatchTagValues)
Inherited Properties: Referenced to Match Rule Factory Provider
Outputs: Match Rule factory
Nested Types: FPCGExMatchSharedTagConfig, EPCGExTagMatchMode (3 modes)
Use Cases: metadata matching, category-based filtering, tag-based association, classification matching, hierarchical grouping
Special Features: Three matching modes, value matching option, attribute-based tag names, subset/superset relationships
Modes: Specific (single tag), Any Shared (intersection), All Shared (subset)
Technical: Tag set comparison, name and value matching, per-element tag specification
-->
