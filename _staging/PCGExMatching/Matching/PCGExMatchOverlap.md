---
icon: square-dashed
description: 'Match : Overlap - Matches based on spatial bounding box overlap.'
---
...
**Add Example**: Box of size 10 with Expansion(2) becomes size 14 (±2 on each side)
**Scale Example**: Box of size 10 with Expansion(1.5) becomes size 15 (50% larger)
...
Default Attribute: `"@Data.Expansion"`
Default Value: `(1, 1, 1)`
...
Default Attribute: `"@Data.MinOverlapRatio"`
Default Value: `0.5`
...
📦 **Module**: `PCGExMatching` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchOverlap.h)
...
Nested Types: FPCGExMatchOverlapConfig, EPCGExMatchOverlapExpansionMode (3 modes)
Use Cases: spatial queries, proximity matching, region-based association, containment tests, spatial filtering
Special Features: AABB overlap testing, bounds expansion, overlap ratio threshold, transitive matching, octree acceleration
Recursion: Supports transitive matching through overlap chains
Technical: Octree spatial index, overlap volume calculation, AABB intersection
Performance: Efficient with large datasets via octree
-->
