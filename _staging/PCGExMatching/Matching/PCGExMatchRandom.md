---
icon: dice
description: 'Match : Random - Probabilistic matching based on random chance.'
---

# Match : Random

Probabilistic matching based on random chance.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExMatching-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchRandom.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Matching/PCGExMatchRandom.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 5 documented (RandomSeed, ThresholdInput, ThresholdAttribute, Threshold, bInvertThreshold)
Inherited Properties: Referenced to Match Rule Factory Provider
Outputs: Match Rule factory
Nested Types: FPCGExMatchRandomConfig
Use Cases: stochastic sampling, probabilistic filtering, random selection, Monte Carlo methods, chance-based effects
Special Features: Deterministic randomness, seeded RNG, per-element probability, threshold inversion
Behavior: Probabilistic matching, reproducible with same seed
Technical: Random number generation, threshold comparison, attribute-based probability
-->
