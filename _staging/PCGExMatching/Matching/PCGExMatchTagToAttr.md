...
description: 'Match : Tags × Attributes - Compares tags on candidates against attribute values on targets.'
---
...
Nested Types: FPCGExMatchTagToAttrConfig
Use Cases: tag-to-data bridging, metadata validation, hybrid matching, category filtering, cross-domain correspondence
Special Features: Tag-to-attribute comparison, name pattern matching, type-specific comparisons, value matching toggle
Comparison Types: Numeric and string operators, tolerance for floating-point
Technical: Tag lookup, attribute reading, type casting, flexible name matching
-->
