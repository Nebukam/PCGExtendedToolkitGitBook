---
icon: gear-code
description: 'Match Rule Factory Provider - Base infrastructure for data matching rules.'
---

# Match Rule Factory Provider
...
![Static Badge](https://img.shields.io/badge/Source-PCGExMatching-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Core/PCGExMatchRuleFactoryProvider.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExMatching/Public/Core/PCGExMatchRuleFactoryProvider.h -->

<!-- VERIFICATION REPORT
Common Properties: 2 documented (Strictness, Invert)
Base Class: Provides foundation for all match rule types
Factory Type: Match Rule
Outputs: Match Rule factory
Derived Types: Multiple match rule implementations inherit from this base
Special Features: Factory pattern, Test interface, recursion support, result inversion
Use Cases: Data pairing, point matching, filtering, data association
Technical: Base configuration class, operation interface, scope-based testing
-->
