---
icon: table
description: 'Tuple - Create structured data with multiple typed columns'
---
...
Inherited Properties: UPCGExSettings base
Outputs: Tuple
Nested Types: FPCGExPropertySchemaCollection, FPCGExPropertyOverrides
-->
