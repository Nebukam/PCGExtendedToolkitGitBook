---
icon: palette
description: 'Sample : Texture - Samples texture data using UV coordinates'
---
...
Node-Specific Properties: 7 documented
  - UVSource
  - bTagIfHasSuccesses, HasSuccessesTag
  - bTagIfHasNoSuccesses, HasNoSuccessesTag
  - bProcessFilteredOutAsFails, bPruneFailedSamples
  - bQuietDuplicateSampleNamesWarning
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Texture Data (Texture Data), Texture Params (Params), Point Filters (Params)
Outputs: Out (Points)
Consumed Factories: FPCGExDataTypeInfoTexParam
-->
