---
icon: vector-polygon
description: 'Sample : Inside Path - Samples points based on whether they lie inside closed paths'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleInsidePath.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleInsidePath.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 25+ documented
  - DataMatching, ProjectionDetails
  - ProcessInputs, SampleMethod, SortDirection
  - bAlwaysSampleWhenInside, bOnlySampleWhenInside, InclusionOffset
  - DistanceType, RangeMin/Input, RangeMax/Input, HeightInclusion
  - WeightMethod, bUseLocalCurve, WeightOverDistance, WeightCurveLookup
  - OutputMode, bWriteSuccess, bWriteDistance, bWriteNumInside, bWriteNumSamples
  - bTagIfHasSuccesses, bTagIfHasNoSuccesses, bIgnoreSelf
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Paths (Points)
Outputs: Out (Points), Success/Failure (Points, conditional)
Nested Types: EPCGExPathSamplingIncludeMode, EPCGExSampleMethod, EPCGExDistanceType, EPCGExSampleInsidePathOutput
-->
