...
description: 'Sample : Line Trace - Performs directed line traces to find collision surfaces'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleSurfaceGuided.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleSurfaceGuided.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 40+ documented
  - SurfaceSource, ActorReference, Origin, Direction, bInvertDirection
  - DistanceInput, MaxDistance, LocalMaxDistance, ApplySampling
  - RotationConstruction, CrossAxis, CollisionSettings
  - bWriteSuccess, bWriteLocation, bWriteLookAt, bWriteNormal, bWriteDistance
  - bOutputNormalizedDistance, bOutputOneMinusDistance, DistanceScale
  - bWriteIsInside, bWriteUVCoords, UVChannel, bWriteFaceIndex, bWriteVertexColor
  - bWriteActorReference, bWriteHitComponentReference, bWritePhysMat
  - bWriteRenderMat, RenderMaterialIndex, bExtractTextureParameters
  - AttributesForwarding
  - bTagIfHasSuccesses, bTagIfHasNoSuccesses
  - bProcessFilteredOutAsFails, bPruneFailedSamples, bQuietUVSettingsWarning
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Actor References (Points), Texture Params (Params), Point Filters (Params)
Outputs: Out (Points)
Nested Types: EPCGExSurfaceSource, EPCGExTraceSampleDistanceInput, FPCGExApplySamplingDetails, etc.
-->
