---
icon: wave-sine
description: 'Sample : Nearest Spline - Samples transforms from nearest spline curves'
---
...
📋 *Visible when Sample Specific Alpha is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleNearestSpline.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleNearestSpline.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 30+ documented
  - SampleInputs, SampleMethod, bSplineScalesRanges
  - RangeMinInput, RangeMin, RangeMaxInput, RangeMax
  - bSampleSpecificAlpha, SampleAlphaInput, SampleAlphaMode, bWrapClosedLoops
  - WeightMethod, WeightOverDistance
  - bWriteSuccess, bWriteTransform, bWriteLookAtTransform
  - bWriteDistance, bWriteSignedDistance, bWriteAlpha, bWriteTangent
  - bWriteNumSamples
  - bTagIfHasSuccesses, bTagIfHasNoSuccesses
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Splines (Spline)
Outputs: Out (Points)
-->
