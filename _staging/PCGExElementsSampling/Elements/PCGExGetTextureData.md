---
icon: image
description: 'Get Texture Data - Creates PCG texture data objects from material or texture paths'
---
...
📋 *Visible when Use Advanced Tiling is enabled*
...
📋 *Visible when Use Advanced Tiling and Use Tile Bounds are enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExGetTextureData.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExGetTextureData.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 14 documented
  - SourceType, SourceAttributeName, bOutputTextureIds, bBuildTextureData
  - Filter, Transform, bUseAbsoluteTransform, ColorChannel, TexelSize
  - Rotation, bUseAdvancedTiling, Tiling, CenterOffset, bUseTileBounds, TileBounds
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Texture Params (Params), Point Filters (Params)
Outputs: Out (Points), Texture Data (Texture Data)
Nested Types: EPCGExGetTexturePathType, EPCGExTextureFilter
-->
