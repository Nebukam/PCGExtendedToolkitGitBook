---
icon: cube
description: 'Sample : Nearest Surface - Finds the closest point on collidable surfaces using traces'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleNearestSurface.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleNearestSurface.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 25+ documented
  - SurfaceSource, ActorReference, MaxDistance, bUseLocalMaxDistance, LocalMaxDistance
  - ApplySampling, CollisionSettings
  ...
  - bWriteIsInside, bWriteActorReference, bWritePhysMat
  - AttributesForwarding
  - bTagIfHasSuccesses, bTagIfHasNoSuccesses
  - bProcessFilteredOutAsFails, bPruneFailedSamples
  - bProcessInsideAsFailedSamples, bProcessOutsideAsFailedSamples
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Actor References (Points), Point Filters (Params)
Outputs: Out (Points)
Nested Types: EPCGExSurfaceSource, FPCGExApplySamplingDetails, FPCGExCollisionDetails
-->
