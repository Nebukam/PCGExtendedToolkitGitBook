---
icon: location-dot
description: 'Sample : Nearest Point - Samples data from nearest target points'
---
...
This node processes **all input points** — each source point finds and samples its own nearby targets. It does *not* find "the one closest pair" between inputs and targets.
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleNearestPoint.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 30+ documented
  - DataMatching, SampleMethod, SortDirection
  - RangeMinInput, RangeMin, RangeMaxInput, RangeMax
  - DistanceDetails, WeightMode, WeightAttribute, WeightRemap
  - BlendingInterface, TargetAttributes, bBlendPointProperties
  - bWriteSuccess, bWriteTransform, bWriteLookAtTransform
  - bWriteDistance, bWriteSignedDistance, bWriteAngle
  - bWriteNumSamples, bWriteSampledIndex
...
Inputs: In (Points), Targets (Points), Point Filters, Sorting Rules, Blending (Params)
Outputs: Out (Points)
-->
