---
icon: plug
description: 'Sample : Sockets - Extracts static mesh sockets as points'
---
...
📋 *Visible when Asset Type = Attribute*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSampleSockets.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 4 documented
  - AssetType, AssetPathAttributeName, StaticMesh
  - OutputSocketDetails (FPCGExSocketOutputDetails with 12 sub-properties)
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Point Filters (Params)
Outputs: Sockets (Points)
Nested Types: EPCGExInputValueType, FPCGExSocketOutputDetails
-->
