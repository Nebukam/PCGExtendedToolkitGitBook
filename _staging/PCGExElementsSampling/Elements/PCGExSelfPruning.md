---
icon: scissors
description: 'Self Pruning - A slower, more precise self pruning node'
---
...
📋 *Visible when Randomize is enabled*
...
📋 *Visible when Primary Mode is not None*
...
📋 *Visible when Secondary Mode is not None*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsSampling-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsSampling/Public/Elements/PCGExSelfPruning.h)
...
Node-Specific Properties: 14 documented
  - Mode, SortDirection, bRandomize, RandomRange
  - NumOverlapAttributeName, Units, bOutputOneMinusOverlap
  - bPreciseTest
  - PrimaryMode, PrimaryExpansionInput, PrimaryExpansion
  - SecondaryMode, SecondaryExpansionInput, SecondaryExpansion
Inherited Properties: From UPCGExPointsProcessorSettings
Inputs: In (Points), Point Filters (Params)
Outputs: Out (Points)
Nested Types: EPCGExSelfPruningMode, EPCGExSortDirection, EPCGExMeanMeasure, EPCGExSelfPruningExpandOrder, EPCGExInputValueType
-->
