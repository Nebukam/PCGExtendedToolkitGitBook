---
icon: image
description: 'Texture Param - Defines texture sampling parameters for material textures'
---
...
Node-Specific Properties: 9 documented (via FPCGExTextureParamConfig)
  - MaterialParameterName, TextureIDAttributeName
  - SampleAttributeName, OutputType, SampledChannels, Scale
  - TextureIndexInput, TextureIndexAttribute, TextureIndex
Base Class: UPCGExFactoryData / UPCGExFactoryProviderSettings
Factory/Provider Pair: UPCGExTexParamFactoryData + UPCGExTexParamProviderSettings
Nested Types: EPCGExTexSampleAttributeType, EPCGExTexChannelsFlags, EPCGExInputValueType
-->
