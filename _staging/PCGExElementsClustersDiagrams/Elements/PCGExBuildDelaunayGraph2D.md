...
description: 'Cluster : Delaunay 2D - Create a 2D delaunay triangulation for each input dataset'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildDelaunayGraph2D.h)
...
Nested Types: EPCGExOptionState, EPCGExUrquhartSiteMergeMode, FPCGExGeo2DProjectionDetails, FPCGExGraphBuilderDetails
-->
