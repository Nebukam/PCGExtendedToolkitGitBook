...
description: 'Cluster : Voronoi 3D - Create a 3D Voronoi graph for each input dataset'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildVoronoiGraph.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildVoronoiGraph.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 7 documented (Method, ExpandBounds, bPruneOutOfBounds, bMarkHull, HullAttributeName, bMarkEdgeOnTouch, GraphBuilderDetails)
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (inherited)
Outputs: Vtx, Edges, Labels
Nested Types: EPCGExOptionState, EPCGExCellCenter, FPCGExGraphBuilderDetails
-->
