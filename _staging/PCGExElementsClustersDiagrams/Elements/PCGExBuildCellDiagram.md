...
description: 'Cluster : Cell Diagram - Creates a graph from cell adjacency relationships'
---
...
- **Compactness Metric**: Compactness measures how close a cell's shape is to a circle (1.0 = perfect circle), calculated as 4*PI*Area/Perimeter^2.
...
*Visible when Write Compactness = true*
...
*Visible when Write Num Nodes = true*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildCellDiagram.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildCellDiagram.h -->
...
Outputs: Vtx, Edges
Nested Types: EPCGExOptionState, FPCGExCellConstraintsDetails, FPCGExGeo2DProjectionDetails, FPCGExGraphBuilderDetails, FPCGExBlendingDetails, FPCGExCarryOverDetails
-->
