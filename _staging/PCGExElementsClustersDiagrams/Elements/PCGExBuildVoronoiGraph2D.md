...
description: 'Cluster : Voronoi 2D - Create a 2D Voronoi graph for each input dataset'
---
...
*Visible when Output Sites = true, Prune Out Of Bounds = true, and Prune Open Sites = false*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildVoronoiGraph2D.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildVoronoiGraph2D.h -->
...
Nested Types: EPCGExOptionState, EPCGExVoronoiMetric, EPCGExCellCenter, FPCGExGeo2DProjectionDetails, FPCGExGraphBuilderDetails, FPCGExVoronoiSitesOutputDetails
-->
