...
description: 'Cluster : Dual Graph - Build the edge dual graph from cluster connectivity'
---
...
*Visible when Write Original Edge Index = true*
...
[![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildDualGraph.h)
...
Inputs: Vtx, Edges
Outputs: Vtx, Edges
Nested Types: EPCGExOptionState, FPCGExGeo2DProjectionDetails, FPCGExGraphBuilderDetails, FPCGExBlendingDetails, FPCGExCarryOverDetails
-->
