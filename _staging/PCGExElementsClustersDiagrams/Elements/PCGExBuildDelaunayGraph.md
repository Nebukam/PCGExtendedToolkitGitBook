...
description: 'Cluster : Delaunay 3D - Create a 3D delaunay tetrahedralization for each input dataset'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildDelaunayGraph.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Diagrams/PCGExBuildDelaunayGraph.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 9 documented (bUrquhart, bOutputSites, bMarkSiteHull, SiteHullAttributeName, bMergeUrquhartSites, bMarkHull, HullAttributeName, bMarkEdgeOnTouch, GraphBuilderDetails)
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: In (inherited)
Outputs: Vtx, Edges, Labels
Nested Types: EPCGExOptionState, FPCGExGraphBuilderDetails
-->
