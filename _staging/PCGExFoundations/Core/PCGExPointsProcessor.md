---
icon: circle-nodes
description: 'Points Processor Settings - Root base class for all point processing operations.'
---
...
**For point operations**: Filtering, sampling, attribute manipulation, spatial queries
**For paths**: Smoothing, resampling, tangent calculation, path analysis
**For clusters**: Pathfinding, edge operations, graph analysis, topology modification
...
*Actual pin names vary by derived processor type*

---

📦 **Module**: `PCGExFoundations` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Core/PCGExPointsProcessor.h)

<!-- VERIFICATION REPORT
Common Properties: None (pure base class, configuration in derived types)
Base Class: Root processor class for all PCGEx point operations
Inputs: Point data collections, optional filters
Outputs: Processed point data
Derived Types: Points, Path, and Cluster processor families
Special Features: Batch processing, multi-threading, filter support, IO management
Architecture: Foundation for three processor families
Technical: Batch coordination, parallel processing, point IO collections
Abstract: Not used directly, only through derived classes
-->
