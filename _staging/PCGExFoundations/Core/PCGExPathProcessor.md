---
icon: route
description: 'Path Processor Settings - Base infrastructure for path processing operations.'
---
...
📦 **Module**: `PCGExFoundations` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Core/PCGExPathProcessor.h)

<!-- VERIFICATION REPORT
Common Properties: 1 documented (bOmitInvalidPathsOutputs)
Base Class: Provides foundation for all path processor types
Inputs: Paths (point data)
Outputs: Paths (processed point data)
Derived Types: Multiple path operations inherit from this base
Special Features: Invalid path filtering, closed loop support, ordered point sequences
Use Cases: Smoothing, resampling, subdivision, analysis, transformation, extraction
Technical: Minimum 2 points for validity, order preservation, loop handling
Path Definition: Ordered sequences with optional closure
-->
