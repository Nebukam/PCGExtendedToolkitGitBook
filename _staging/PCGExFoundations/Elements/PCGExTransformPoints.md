...
description: 'Transform Points - Applies transform variations to points with attribute override support.'
---
...
📋 *Visible when Snap Position != None*
...
📋 *Visible when Snap Rotation != None*
...
📋 *Visible when Reset Point Center = true*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/PCGExTransformPoints.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/PCGExTransformPoints.h -->
...
Inherited Properties: UPCGExPointsProcessorSettings, optional point filters
Transform Components: Position, Rotation, Scale
Value Sources: Constant or Attribute (per-point)
Snapping Modes: None, Snap Offset, Snap Result
Special Features: Per-component ranges, scaling multipliers, absolute/local space, uniform scale, bounds modification
Use Cases: Transform variation, randomization, procedural placement, attribute-driven transforms
-->
