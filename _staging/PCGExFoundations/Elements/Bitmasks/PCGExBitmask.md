---
icon: binary
description: 'Bitmask - Creates a bitmask configuration for efficient multi-flag storage.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Bitmasks/PCGExBitmask.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Bitmasks/PCGExBitmask.h -->

<!-- VERIFICATION REPORT
Properties: 2 documented (Bitmask with nested properties, TitleCharLimit)
Outputs: Bitmask configuration
Node Type: Parameter generator
Use Cases: state management, feature flags, multi-category classification, permission systems
Special Features: Individual bits, mutations, compositions, bitwise operations
Bit Operations: AND, OR, XOR, NOT
Capacity: 64 flags in single int64
Technical: Bit manipulation, flag storage, efficient multi-boolean representation
-->
