---
icon: calculator
description: 'Bitmask Operation - Applies bitwise operations to point attributes.'
---
...
**Set**: Overwrites the attribute value
**OR**: Adds flags without removing existing ones
**AND**: Removes flags not in the mask
**XOR**: Flips flags specified in the mask
**NOT**: Ignores mask, inverts all bits
...
**Constant**: Efficient, same operation on all points
**Attribute**: Flexible, per-point custom masks
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Bitmasks/PCGExBitwiseOperation.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Bitmasks/PCGExBitwiseOperation.h -->

<!-- VERIFICATION REPORT
Properties: 5 documented (FlagAttribute, Operation, MaskInput, MaskAttribute, Bitmask)
Base Class: Points Processor (batch processing, multi-threading)
Operations: Set, OR, AND, XOR, NOT
Input Types: Constant or Attribute
Use Cases: state management, feature flags, visibility control, classification, condition marking
Technical: int64 attributes, bitwise operations, per-point processing
