---
icon: list-dropdown
description: 'Enum Constant - Converts enum values into PCG constants.'
---
...
*Output pin names vary based on OutputMode and selected enum values*

---

📦 **Module**: `PCGExFoundations` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Constants/PCGExConstantEnum.h)
...
Output Modes: Single, All, All to Separate Outputs, Selection, Selection to Separate Outputs
Output Types: Keys, Descriptions, Values, Bitflags
Use Cases: configuration systems, dropdown implementations, state machines, category systems
Special Features: Multiple output modes, flexible attribute naming, bitflag conversion, namespace stripping
Technical: Enum metadata extraction, dynamic pin generation, attribute set creation
-->
