...
description: 'Constant - Outputs predefined mathematical and vector constants as PCG data.'
---
...
<details>
<summary><strong>Attribute Name Map</strong> <code>TMap<FName, FName></code></summary>
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Constants/PCGExConstants.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Constants/PCGExConstants.h -->
...
Inherited Properties: BulkInitData, CacheData, ScopedAttributeGet, bFlattenOutput, bCleanupConsumableAttributes, etc. from UPCGExSettings base class
Inputs: None (parameter generator)
Outputs: Param Data with constants
Constant Lists: 19 categories (numeric, irrational, angle, vector, boolean)
Transformations: Negate, reciprocal, custom multiplier
Output Types: Double, Float, Int32, Int64
Special Features: Attribute name mapping, combined transformations
-->
