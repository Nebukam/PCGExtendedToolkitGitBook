---
icon: hand-pointer
description: 'Cherry Pick Points - Filters points by indices using picker configurations.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Filtering/PCGExCherryPickPoints.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Filtering/PCGExCherryPickPoints.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented (bInvert, bOutputDiscardedPoints, bAllowEmptyOutputs)
Inherited Properties: UPCGExPointsProcessorSettings base class
Consumed Factories: Picker factories (Constant, Range, Attribute-based)
Inputs: Point data, picker factories
Outputs: Filtered points, optional discarded points
Filter Logic: Index-based selection with union of multiple pickers
Special Features: Inversion, separate discarded output, empty collection handling
Use Cases: Point subset extraction, manual selection, exclusion filtering
-->
