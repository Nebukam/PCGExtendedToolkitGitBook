---
icon: filter-list
description: 'Discard By Point Count - Filters out point collections based on their point count.'
---
...
📋 *Visible when Remove Below = true*
...
📋 *Visible when Remove Above = true*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Filtering/PCGExDiscardByPointCount.h)
...
Outputs: Kept collections, optional discarded collections
Filter Logic: Point count range (min and/or max)
Use Cases: Removing degenerate data, size constraints, fragment cleanup
Special Features: Separate min/max toggles, empty output handling, discard output
-->
