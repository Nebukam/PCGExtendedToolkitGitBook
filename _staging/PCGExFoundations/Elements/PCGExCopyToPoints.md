---
icon: copy
description: 'Copy to Points - Copies source points to target point locations with transform fitting and attribute forwarding.'
---
...
Options:
- **Enabled**: Whether to scale
- **Uniform**: Maintain aspect ratio when scaling
- **Scale Method**: How to compute scale factor
...
Supports 3D alignment (X, Y, Z axes independently):
- **Min**: Align to minimum edge
- **Center**: Center alignment
- **Max**: Align to maximum edge

Examples: Bottom-left, center, top-right, etc.
...
**Add Index Tag**: Include target point index as tag
**Attributes**: List of attributes to convert to tags
**Prefix**: Tag naming options
...
**Enabled**: Whether to forward attributes
**Filter Mode**: All, Whitelist, or Blacklist
**Attribute Names**: Specific attributes to forward/exclude
**Preserve PCGEx Data**: Keep PCGEx-specific metadata
...
📦 **Module**: `PCGExFoundations` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/PCGExCopyToPoints.h)
...
Transform Details: ScaleToFit, Justification, bInheritScale, bInheritRotation, bIgnoreBounds
Data Matching: Mode, ClusterMatchMode, bSplitUnmatched, bLimitMatches, Limit
Attribute Forwarding: Filter mode, attribute selection, preserve options
Inputs: Source collections, target points
Outputs: Copied points, optional unmatched
Use Cases: Instancing, placement, scattering, transform inheritance
Special Features: Scale-to-fit, justification, data matching, attribute forwarding, tags conversion
-->
