---
icon: fingerprint
description: 'Get GUID - Retrieves a single GUID from a specific point index as param data.'
---
...
**Integer**: Compact numeric representation
**String**: Human-readable, configurable format
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Utils/PCGExGetGUID.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Utils/PCGExGetGUID.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 3 documented (Index, IndexSafety, Config)
GUID Config Properties: 10 documented (OutputAttributeName, OutputType, Format, Uniqueness, UniqueKeyInput, UniqueKey, GridHashCollision, PositionHashCollision, PositionHashOffset, bAllowInterpolation)
Index Safety Modes: Ignore, Tile, Clamp, Yoyo
Output Types: Integer (int64), String (formatted)
String Formats: 5 formats (Digits, DigitsLower, with hyphens variations)
Uniqueness Factors: Grid, Position, Key (bitmask)
Inputs: Point data
Outputs: Param data with single GUID
Use Cases: Lookup keys, deterministic IDs, seeding, single-point identification
-->
