---
icon: object-group
description: 'Merge Points - Combines point collections into merged datasets with optional grouping.'
---
...
**Split Unmatched**: Whether to separate unmatched collections
**Limit Matches**: Restrict how many collections per group
...
📋 *Visible when Matching Details Mode != Disabled*
...
Controls attribute filtering, tag filtering, and default value preservation.

**Attributes**: Attribute name filter settings
**Tags**: Tag name filter settings
**Preserve Default Values**: Whether to preserve attribute default values
...
**Names**: Specific attributes to include/exclude
**Data Domain to Elements**: Copy @Data domain attributes to point attributes
...
**Filter Mode**: All, Whitelist, or Blacklist
**Names**: Specific tags to include/exclude
**Flatten Tag Value**: Convert tag values to simple presence flags
...
📦 **Module**: `PCGExFoundations` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Utils/PCGExMergePoints.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 4 documented (MatchingDetails, bExclusivePartitions, SortDirection, CarryOverDetails)
Matching Modes: Disabled (merge all), Tag, Attribute, Index
Partition Types: Exclusive (one group), Non-exclusive (multiple groups)
Carry-Over Controls: Attributes, Tags, preserve defaults
Sort Directions: Ascending, Descending
Inputs: Multiple point collections
Outputs: Merged collections, optional unmatched
Use Cases: Consolidation, grouping by category, batch merging
Special Features: Flexible matching, attribute filtering, tag filtering
-->
