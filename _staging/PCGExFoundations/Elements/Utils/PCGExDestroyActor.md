---
icon: trash
description: 'Destroy Actor - Destroys actors previously spawned by PCG based on actor reference attributes.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Elements/Utils/PCGExDestroyActor.h)
...
Inputs: Point data with actor references
Outputs: Pass-through point data
Actor Scope: Only actors spawned by current PCG component
Safety: Protected against destroying non-PCG actors
Use Cases: Cleanup, regeneration, instance removal, procedural content management
Execution: Async destruction on main thread
-->
