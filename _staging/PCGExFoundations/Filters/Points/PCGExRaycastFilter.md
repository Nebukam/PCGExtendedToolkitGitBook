---
icon: filter
description: 'Filter : Raycast - Filters points based on raycast results against surfaces.'
---
...
📋 *Visible when Test Mode = Compare Distance*
...
📋 *Visible when Test Mode = Compare Distance and Comparison = Nearly Equal or Nearly Not Equal*
...
📋 *Visible when Origin Mode is not Point Position*
...
→ See [Collision Details](/settings/collision-details.md) for full reference.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Filters/Points/PCGExRaycastFilter.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Filters/Points/PCGExRaycastFilter.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 14 documented
Inherited Properties: Referenced to UPCGExPointFilterFactoryData base
Inputs: Actor References (optional)
Outputs: None (filter provider)
Nested Types: EPCGExRaycastTestMode, EPCGExRaycastOriginMode, FPCGExRaycastFilterConfig
-->
