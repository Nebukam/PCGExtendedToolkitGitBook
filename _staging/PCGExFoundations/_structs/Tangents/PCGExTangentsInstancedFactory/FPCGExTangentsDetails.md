---
icon: bezier-curve
description: 'Tangents Details - Configure spline tangent source and scaling'
---
...
Nested Types: EPCGExTangentSource, FPCGExTangentsScalingDetails, UPCGExTangentsInstancedFactory
Used By: Staging Spline Mesh, Copy to Path
-->
