---
icon: puzzle-piece
description: 'Tangents (Base) - Base factory and configuration structures for tangent calculation systems.'
---
...
- **[Auto](PCGExTangentsAuto.md)** - Geometric tangents from neighboring point positions
- **[Catmull-Rom](PCGExTangentsCatmullRom.md)** - Classic spline interpolation (C1 continuous)
- **[From Neighbors](PCGExTangentsFromNeighbors.md)** - Direction-averaged bisector tangents
- **[From Transform](PCGExTangentsFromTransform.md)** - Transform-aligned tangents based on point rotation
- **[Zero](PCGExTangentsZero.md)** - Zero-length tangents (linear interpolation)
...
- [Auto Tangents](PCGExTangentsAuto.md)
- [Catmull-Rom Tangents](PCGExTangentsCatmullRom.md)
- [From Neighbors Tangents](PCGExTangentsFromNeighbors.md)
- [From Transform Tangents](PCGExTangentsFromTransform.md)
- [Zero Tangents](PCGExTangentsZero.md)
...
📦 **Module**: `PCGExFoundations` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Tangents/PCGExTangentsInstancedFactory.h)

<!-- VERIFICATION REPORT
Base Class Type: Abstract Instanced Factory
Tangent Sources: None, Attribute, In-place
Configuration Structs: FPCGExTangentsDetails, FPCGExTangentsScalingDetails
Implementations: Auto, CatmullRom, FromNeighbors, FromTransform, Zero
Tangent Components: Arrive (incoming), Leave (outgoing)
Edge Handling: Optional Start/End overrides for first/last points
Scaling: Independent arrive/leave scale factors (constant or attribute)
Purpose: Common framework for all tangent calculation methods
-->
