---
icon: puzzle-piece
description: 'Catmull-Rom - Calculates tangents using Catmull-Rom spline interpolation.'
---
...
→ See [Write Tangents](../../elements/paths/write-tangents.md) for tangent scaling configuration.
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Tangents/PCGExTangentsCatmullRom.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Tangents/PCGExTangentsCatmullRom.h -->
...
Computation: Tangent = 0.5 * (Next - Prev) for both arrive and leave
Tangent Direction: Both parallel, pointing from prev to next
Continuity: C1 continuous (smooth first derivatives)
Characteristics: Passes through control points, no overshooting, local control
Proportional Scaling: Tangent length scales with neighbor distance
Use Cases: Smooth splines, classic interpolation, balanced curvature, C1 continuity
Related Factories: Auto, FromNeighbors, FromTransform, Zero
-->
