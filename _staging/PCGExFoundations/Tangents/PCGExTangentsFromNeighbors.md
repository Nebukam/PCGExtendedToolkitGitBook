---
icon: puzzle-piece
description: 'From Neighbors - Calculates tangents by averaging incoming and outgoing directions.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExFoundations-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Tangents/PCGExTangentsFromNeighbors.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExFoundations/Public/Tangents/PCGExTangentsFromNeighbors.h -->
...
Algorithm: Direction averaging (bisector)
Computation: Tangent = Lerp(IncomingDir, OutgoingDir, 0.5)
Tangent Direction: Both parallel, bisecting incoming/outgoing angle
Characteristics: Symmetric curvature, smooth angular transitions, flow-based
Averaging: 50% blend of prev→current and current→next directions
Use Cases: Smooth transitions, angle bisection, corner smoothing, directional flow
Related Factories: Auto, CatmullRom, FromTransform, Zero
-->
