...
description: 'Edges Processor Settings - Base infrastructure for cluster/edge processing operations.'
---

# Edges Processor Settings
...
![Static Badge](https://img.shields.io/badge/Module-PCGExGraphs-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExGraphs/Public/Core/PCGExClustersProcessor.h)

<!-- VERIFICATION REPORT
Common Properties: 2 documented (ScopedIndexLookupBuild, bQuietMissingClusterPairElement)
Base Class: Provides foundation for all cluster processor types
Inputs: Source Vertices, Source Edges
Outputs: Output Vertices, Output Edges
Derived Types: Multiple cluster operations inherit from this base
Special Features: Cluster pairing, batch processing, edge sorting support, scoped indexing
Use Cases: Pathfinding, edge filtering, cluster analysis, topology modification, graph operations
Technical: Vertex-edge relationships, batch coordination, multi-threading support
-->
