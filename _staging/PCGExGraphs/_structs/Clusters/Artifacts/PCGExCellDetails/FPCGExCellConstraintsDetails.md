---
icon: border-all
description: 'Cell Constraints Details - Filter and validate discovered cells'
---
...
📋 *Visible when used for path output*
...
Nested Types: EPCGExCellRotationMethod, EPCGExWinding, EPCGExCellShapeTypeOutput
Used By: Cell Diagram, Find All Cells, Find Cells, Find Cluster Hull, Topology
-->
