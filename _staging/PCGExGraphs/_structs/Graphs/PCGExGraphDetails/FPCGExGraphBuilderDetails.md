...
description: 'Graph Builder Details - Configure cluster output and edge data generation'
---
...
📋 *Visible when Remove Small Clusters = true*
...
📋 *Visible when Remove Big Clusters = true*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExGraphs-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExGraphs/Public/Graphs/PCGExGraphDetails.h)
...
Nested Types: FPCGExBasicEdgeSolidificationDetails, EPCGExOptionState, FPCGExGeo2DProjectionDetails
Used By: 17+ cluster-building nodes (Delaunay, Voronoi, Convex Hull, etc.)
-->
