---
icon: route
description: 'Path : Split - Split existing paths into multiple new paths.'
---
...
📋 *Visible when Split Action = Switch or Partition*
...
📋 *Visible when Tag If Even Split = true*
...
📋 *Visible when Tag If Odd Split = true*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExSplitPath.h)
...
Inputs: Points, Split Conditions (Filter Factories)
Outputs: Points (inherited)
Nested Types: EPCGExPathSplitAction, EPCGExPathSplitInitialValue
-->
