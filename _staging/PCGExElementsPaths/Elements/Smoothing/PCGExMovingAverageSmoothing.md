---
icon: puzzle-piece
description: 'Moving Average Smoothing - Gather neighbors using a sliding window along the path.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/Smoothing/PCGExMovingAverageSmoothing.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/Smoothing/PCGExMovingAverageSmoothing.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (IndexSafety)
Type: Instanced Factory for UPCGExSmoothSettings
Nested Types: EPCGExIndexSafety
-->
