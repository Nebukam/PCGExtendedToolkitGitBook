---
icon: crosshairs
description: 'Path × Path Crossings - Find crossing points between and within paths.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExPathCrossings.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExPathCrossings.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 20+ documented
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points, Can Cut Filters, Can Be Cut Filters
Outputs: Points (inherited)
Nested Types: FPCGExPathEdgeIntersectionDetails, FPCGExCarryOverDetails, FPCGExBlendingDetails, EPCGExAxis
-->
