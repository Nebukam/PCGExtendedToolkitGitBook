---
icon: route
description: 'Path : Smooth - Smooth path data using neighbor gathering and BlendOps.'
---
...
| Option | Description |
|--------|-------------|
| **[Moving Average](./Smoothing/PCGExMovingAverageSmoothing.md)** | Gathers neighbors within a sliding window along the path. |
| **[Radius](./Smoothing/PCGExRadiusSmoothing.md)** | Gathers points within a spatial radius, ignoring path order. |
...
📋 *Visible when Smoothing Amount Type = Constant*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExSmooth.h)

<!-- VERIFICATION REPORT
Node-Specific Properties: 10 documented (bPreserveStart, bPreserveEnd, SmoothingMethod, InfluenceInput, InfluenceConstant, SmoothingAmountType, SmoothingAmountConstant, ScaleSmoothingAmountAttribute, BlendingInterface, BlendingSettings)
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points, Filters (Filter Factories), Overrides : Smoothing (Smoothing Factories)
Outputs: Points (inherited)
Nested Types: EPCGExInputValueType, EPCGExBlendingInterface, FPCGExBlendingDetails
-->
