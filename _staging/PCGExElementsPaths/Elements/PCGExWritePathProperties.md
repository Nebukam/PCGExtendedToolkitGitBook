---
icon: route
description: 'Path : Properties - Compute and write comprehensive path metrics and per-point data.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExWritePathProperties.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExWritePathProperties.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 40+ documented (path attributes, point attributes, tagging, inclusion settings)
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points (inherited)
Outputs: Out, Outer, Inner, Odd, PathProperties
Nested Types: FPCGExGeo2DProjectionDetails, FPCGExInclusionDetails, EPCGExAttributeSetPackingMode, EPCGExAngleRange
-->
