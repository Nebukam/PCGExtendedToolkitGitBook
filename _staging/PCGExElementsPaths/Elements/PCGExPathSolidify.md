---
icon: route
description: 'Path : Solidify - Convert path points into segment-like bound representations.'
---
...
📋 *Visible when Use Construction Mapping = false*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExPathSolidify.h)
...
Nested Types: EPCGExAxisOrder, EPCGExMakeRotAxis, FPCGExPathSolidificationAxisDetails, FPCGExPathSolidificationRadiusDetails, EPCGExPathNormalDirection
-->
