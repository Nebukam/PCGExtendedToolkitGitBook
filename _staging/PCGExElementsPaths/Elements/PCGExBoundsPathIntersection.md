---
icon: crosshairs
description: 'Path × Bounds Intersection - Find intersections between paths and target point bounds.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExBoundsPathIntersection.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExBoundsPathIntersection.h -->
...
Inputs: Points (paths), Bounds (target points)
Outputs: Points (inherited)
Nested Types: FPCGExMatchingDetails, FPCGExBoxIntersectionDetails
-->
