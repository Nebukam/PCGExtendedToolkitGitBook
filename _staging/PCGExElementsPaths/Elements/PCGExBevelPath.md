...
description: 'Path : Bevel - Bevel path corners with configurable profiles.'
---
...
📋 *Visible when Subdivide = true and Type ≠ Custom*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExBevelPath.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExBevelPath.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 21+ documented
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points, Bevel Conditions (Filter Factories), Profile (Points)
Outputs: Points (inherited)
Nested Types: EPCGExBevelMode, EPCGExBevelProfileType, EPCGExBevelLimit, EPCGExBevelCustomProfileScaling, EPCGExSubdivideMode
-->
