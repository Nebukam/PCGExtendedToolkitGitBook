---
icon: arrows-to-line
description: 'Path : Insert - Insert target points into paths at their nearest location'
---
...
→ See [Matching Details](../../_shared/FPCGExMatchingDetails.md)
...
📋 *Visible when Edge Interior Only = false*
...
📋 *Visible when Within Range = true*
...
📋 *Visible when Limit Inserts Per Edge = true*
...
📋 *Visible when Limit Inserts Per Edge = true and Limit Mode = Spacing*
...
📋 *Visible when Prevent Collocation = true*
...
→ See [Forward Details](../../_shared/FPCGExForwardDetails.md)
...
📋 *Visible when Flag Inserted Points = true*
...
📋 *Visible when Write Distance = true*
...
📋 *Visible when Write Target Index = true*
...
📋 *Visible when Tag If Has Inserts = true*
...
📋 *Visible when Tag If No Inserts = true*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExPathInsert.h)
...
Inherited Properties: UPCGExPathProcessorSettings base (cleanup, warnings, path output options)
Inputs: In (paths), Targets (points)
Outputs: Out (modified paths)
Nested Types: EPCGExInsertLimitMode, FPCGExMatchingDetails, FPCGExForwardDetails, UPCGExSubPointsBlendInstancedFactory
-->
