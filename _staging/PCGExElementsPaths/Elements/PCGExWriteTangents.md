...
📋 *Visible when Arrive Scale Input = Constant*
...
📋 *Visible when Leave Scale Input = Constant*
...
📦 **Module**: `PCGExElementsPaths` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExWriteTangents.h)
