...
description: 'Path : Fuse Collinear - Remove collinear points from paths to simplify geometry.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExFuseCollinear.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExFuseCollinear.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 8 documented (Threshold, bInvertThreshold, bFuseCollocated, FuseDistance, bDoBlend, BlendingDetails, UnionDetails, bOmitInvalidPathsFromOutput)
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points, Keep Conditions (Filter Factories)
Outputs: Points (inherited)
Nested Types: FPCGExBlendingDetails, FPCGExUnionMetadataDetails
-->
