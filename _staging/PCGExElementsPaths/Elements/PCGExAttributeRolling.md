...
description: 'Path : Attribute Rolling - Segment paths into ranges and optionally blend attributes within them.'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExAttributeRolling.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExAttributeRolling.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 16 documented
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points, Filter Factories (Toggle/Start/Stop/Pin), Blend Op Factories
Outputs: Points (inherited)
Nested Types: EPCGExRollingRangeControl, EPCGExRollingValueControl, EPCGExRollingToggleInitialValue
-->
