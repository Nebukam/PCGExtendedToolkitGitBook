...
📋 *Visible when Mode = Sweep and Resolution Mode = Distance*
...
📋 *Visible when Redistribute Evenly = false, Mode = Sweep, and Resolution Mode = Distance*
...
📦 **Module**: `PCGExElementsPaths` · 📄 [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExPathResample.h)
