---
icon: puzzle-piece
description: 'Orient Operation - Base factory for path orientation methods.'
---
...
- **[Average](./PCGExOrientAverage.md)** - Averages directions to neighboring points for smooth orientation
- **[Look At](./PCGExOrientLookAt.md)** - Orients toward a target point, direction, or position

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/Orient/PCGExOrientOperation.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/Orient/PCGExOrientOperation.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 0 (abstract base class)
Inherited Properties: N/A
Inputs: N/A (factory base class)
Outputs: N/A (factory base class)
Nested Types: None
-->
