---
icon: route
description: 'Path : Subdivide - Subdivide path segments by adding intermediate points.'
---
...
📋 *Visible when Subdivide Method ≠ Manhattan*
...
📋 *Visible when Subdivide Method = Distance*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExSubdivide.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExSubdivide.h -->
...
Inputs: Points, Filters (Filter Factories), Labels
Outputs: Points (inherited)
Nested Types: EPCGExSubdivideMode, EPCGExInputValueType, FPCGExManhattanDetails
-->
