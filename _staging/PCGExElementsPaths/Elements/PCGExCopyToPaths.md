...
description: 'Copy to Path - Deform points along a path or spline.'
---
...
📋 *Visible when Custom Point Type is enabled or Default Point Type = CurveCustomTangent*
...
→ See [Points Processor Settings](../../PCGEx/Core/PCGExPointsProcessor.md) for: Point data handling options.

---

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExCopyToPaths.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExCopyToPaths.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 17+ documented
Inherited Properties: Referenced to UPCGExPointsProcessorSettings
Inputs: Points (to deform), Paths (target paths)
Outputs: Points (inherited)
Nested Types: FPCGExMatchingDetails, EPCGExSplinePointType, FPCGExTangentsDetails, EPCGExAxisOrder, FPCGExAxisDeformDetails
-->
