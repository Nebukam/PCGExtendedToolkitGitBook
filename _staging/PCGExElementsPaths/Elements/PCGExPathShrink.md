---
icon: route
description: 'Path : Shrink - Shrink path from its beginning and end.'
---
...
📋 *Visible when Shrink Endpoint = Start and End*
...
📋 *Visible when Shrink Mode = Distance*
...
📋 *Visible when Shrink Mode = Distance, Shrink Endpoint = Start and End, and Settings Mode = Separate*
...
📋 *Visible when Shrink Mode = Count*
...
📋 *Visible when Shrink Mode = Count, Shrink Endpoint = Start and End, and Settings Mode = Separate*
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExPathShrink.h)
...
Inputs: Points, Stop Conditions (Filter Factories)
Outputs: Points (inherited)
Nested Types: EPCGExShrinkEndpoint, EPCGExShrinkConstantMode, EPCGExPathShrinkMode, FPCGExShrinkPathEndpointDistanceDetails, FPCGExShrinkPathEndpointCountDetails, EPCGExPathShrinkDistanceCutType
-->
