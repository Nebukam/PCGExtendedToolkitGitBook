...
description: 'Path : Offset - Offset path points perpendicular to the path direction.'
---
...
📋 *Visible when Offset Input = Constant*
...
📋 *Visible when Offset Method = Slide and Direction Type = Constant*
...
📋 *Visible when Offset Method = Slide*
...
📋 *Visible when Adjustment = Custom Smooth*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExOffsetPath.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExOffsetPath.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 11 documented (OffsetMethod, OffsetInput, Offset, bApplyPointScaleToOffset, UpVectorConstant, DirectionType, Direction, bInvertDirection, Adjustment, AdjustmentScale, MitreLimit)
...
Nested Types: EPCGExOffsetMethod, EPCGExPathNormalDirection, EPCGExOffsetAdjustment
-->
