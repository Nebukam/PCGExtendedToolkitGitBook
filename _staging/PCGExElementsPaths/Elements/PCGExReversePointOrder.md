...
description: 'Reverse Order - Reverse the order of points or change winding of paths.'
---
...
📋 *Visible when Method = Sorting Rules*
...
📋 *Visible when Tag If Reversed = true*
...
📋 *Visible when Tag If Not Reversed = true*
...
Inherited Properties: None specific (uses UPCGExPointsProcessorSettings)
Inputs: Points, Sorting Rules (Sort Rules Factories)
Outputs: Points (inherited)
Nested Types: EPCGExPointReverseMethod, EPCGExSortDirection, EPCGExWinding, FPCGExGeo2DProjectionDetails, FPCGExSwapAttributePairDetails
-->
