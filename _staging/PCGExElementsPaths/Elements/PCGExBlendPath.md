...
description: 'Path : Blend - Blend point attributes along a path between start and end points.'
---
...
📋 *Visible when Blend Over = Fixed and Lerp Input = Constant*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsPaths-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExBlendPath.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsPaths/Public/Elements/PCGExBlendPath.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 6 documented (BlendOver, LerpInput, Lerp, BlendingSettings, bBlendFirstPoint, bBlendLastPoint)
Inherited Properties: Referenced to UPCGExPathProcessorSettings
Inputs: Points, Blending (Blend Op Factories)
Outputs: Points (inherited)
Nested Types: EPCGExBlendOver, FPCGExBlendingDetails
-->
