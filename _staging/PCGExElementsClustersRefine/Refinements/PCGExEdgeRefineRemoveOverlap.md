---
icon: puzzle-piece
description: 'Refine : Overlap - Removes edges that overlap or pass too close to other edges'
---
...
📋 *Visible when Use Min Angle is enabled*
...
📋 *Visible when Use Max Angle is enabled*
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Refining/PCGExEdgeRefineRemoveOverlap.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Refining/PCGExEdgeRefineRemoveOverlap.h -->
...
Nested Types: EPCGExEdgeOverlapPick
-->
