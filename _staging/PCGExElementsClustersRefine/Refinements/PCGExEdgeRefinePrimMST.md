---
icon: puzzle-piece
description: 'Refine : MST (Prim) - Produces a minimum spanning tree using Prim''s algorithm'
---
...
![Static Badge](https://img.shields.io/badge/Source-PCGExElementsClusters-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Refining/PCGExEdgeRefinePrimMST.h)

<!-- SOURCE: https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsClusters/Public/Elements/Refining/PCGExEdgeRefinePrimMST.h -->

<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (bInvert)
Inherited Properties: None (instanced factory)
Inputs: Requires Heuristics
