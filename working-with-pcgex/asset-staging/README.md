...
>
> _Mesh Collections can also be used with_ [spline-mesh.md](../../node-library/assets-management/spline-mesh.md "mention")_._
{% endstep %}
{% endstepper %}
...
<figure><img src="../../.gitbook/assets/image (3) (1) (1).png" alt=""><figcaption><p>Entries can be either an asset, or another collection!</p></figcaption></figure>
...
* `SM descriptor` is only used by Spline Mesh components generated by the [Spline Mesh](../../node-library/assets-management/spline-mesh.md) node
