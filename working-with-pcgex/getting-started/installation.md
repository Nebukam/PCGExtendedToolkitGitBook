...
<summary>Gumroad precompiled binaries (backup)</summary>
...
#### 1 - Go to the Gumroad PCGEx page
...
#### 2 - Extract into your project Plugins folder
...
{% content-ref url="/broken/spaces/OlikRK7aov5rqpXg9pfX/pages/nB51AFqAyPS6NMsHmpE2" %}
[Broken link](/broken/spaces/OlikRK7aov5rqpXg9pfX/pages/nB51AFqAyPS6NMsHmpE2)
{% endcontent-ref %}
