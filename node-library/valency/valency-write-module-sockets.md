...
📋 _Visible when Output Source Index is enabled_
...
📋 _Visible when Output Socket Name is enabled_
...
📋 _Visible when Output Socket Type is enabled_
...
→ See Valency Processor for: Bonding Rules reference → See **Clusters Processor Settings** for: Vtx/Edge handling, cluster output options
...
![Static Badge](https://img.shields.io/badge/Module-PCGExElementsValency-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsValency/Public/Elements/PCGExWriteModuleSockets.h)
