...
4. **Constraint-Aware Selection**: Checks if any candidate _must_ be selected now (urgency >= 1.0, meaning no slots to spare). If so, forces that module. Otherwise, selects via weighted random with urgency-based weight boosting.
...
→ See Solver Factory for: base solver interface

***

![Static Badge](https://img.shields.io/badge/Source-PCGExElementsValency-473F69)  ·  [Source](https://github.com/Nebukam/PCGExtendedToolkit/blob/main/Source/PCGExElementsValency/Public/Solvers/PCGExValencyConstraintSolver.h)
