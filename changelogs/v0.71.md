...
The Bitmask Adjacency state is a state that takes bitmask reference and/or [bitmasks-collection.md](../node-library/assets-management/collections/bitmasks-collection.md "mention")and uses internal directions to apply bitmasks directly. It's designed to be pair well with [probe-bitmasks.md](../node-library/clusters/connect-points/probe-bitmasks.md "mention").

<figure><img src="../.gitbook/assets/image (135).png" alt=""><figcaption></figcaption></figure>

### [Probe : Bitmasks](../node-library/clusters/connect-points/probe-bitmasks.md)

Bitmask Probe is a [connect-points](../node-library/clusters/connect-points/ "mention")**probe** that takes bitmask reference and/or [bitmasks-collection.md](../node-library/assets-management/collections/bitmasks-collection.md "mention")and uses internal directions. It makes it much easier and straightforward to connect direction and then write corresponding states!

<figure><img src="../.gitbook/assets/image (134).png" alt=""><figcaption></figcaption></figure>

### [Fibonacci Lattices](../node-library/misc/shapes/shape-sphere.md) (φ Sphere)
...
### [Data Bounds Aspect](../node-library/filters/filters-collections/data-bounds.md)
