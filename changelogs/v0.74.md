...
Long overdue, I've been doing a lot of cleanup on the tensor side. A few optimizations, and a major overhaul of the [extrude-tensors.md](../node-library/tensors/extrude-tensors.md "mention") code to make it more maintainable and extendable.
...
> This will affect the [asset-staging](../node-library/assets-management/asset-staging/ "mention") node as well as [spline-mesh.md](../node-library/assets-management/spline-mesh.md "mention")

<details>

<summary>Renamed staging  nodes</summary>
...
I've always wanted to be able to expand the collection system in new ways to make it less of a "narrow" tool; the recent addition of [pcgdataasset-loader.md](../node-library/assets-management/pcgdataasset-loader.md "mention") and the experimental [valency.md](../working-with-pcgex/valency.md "mention") ecosystem, I started wanting more.
