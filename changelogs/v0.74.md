...
The changes listed here are only available on **main** branch (UE 5.7)
{% endhint %}

0.74 is a big update with important changes; make sure to at least scan the titles in case something would unexpectedly affect your workflow!
...
<div><figure><img src="../.gitbook/assets/image (10).png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/image (1) (1) (1) (1).png" alt=""><figcaption></figcaption></figure></div>
...
## [Valency](../working-with-pcgex/valency/) <sup><mark style="color:$warning;">Experimental<mark style="color:$warning;"></sup>
...
> There's some [basic doc available](../working-with-pcgex/valency/) (Ai-generated from the codebase)
