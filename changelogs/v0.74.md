...
Cells finding nodes now have their partition friendly (Bounded) companion nodes that replicates the [spatial-triage.md](../node-library/quality-of-life/spatial-triage.md "mention") behavior to only output relevant cells to different bins!

<figure><img src="../.gitbook/assets/image (1) (1) (1).png" alt=""><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/image (4).png" alt=""><figcaption></figcaption></figure>

### [Cell Diagram](../node-library/clusters/diagrams/cell-diagram.md) <sup><mark style="color:$success;">New Node<mark style="color:$success;"></sup>
...
[flood-fill](../node-library/clusters/flood-fill/ "mention") got its fair share of improvements as well, growing to extents that made it a good candidate for a new module entirely. It comes with a _lot_ of very specific code & subnodes that not everybody will care about so I figured let's make it optional.
...
* [fc-hx-scoring.md](../node-library/clusters/flood-fill/fc-hx-scoring.md "mention")&#x20;
* [fc-hx-budget.md](../node-library/clusters/flood-fill/fc-hx-budget.md "mention")
* [fc-hx-threshold.md](../node-library/clusters/flood-fill/fc-hx-threshold.md "mention")
* [fc-attribute-accumulation.md](../node-library/clusters/flood-fill/fc-attribute-accumulation.md "mention")
* [fc-hx-threshold.md](../node-library/clusters/flood-fill/fc-hx-threshold.md "mention")
...
I've always wanted to be able to expand the collection system in new ways to make it less of a "narrow" tool; the recent addition of [pcgdataasset-loader.md](../node-library/assets-management/pcgdataasset-loader.md "mention") and the experimental [valency](../working-with-pcgex-1/valency/valency/ "mention") ecosystem, I started wanting more.
...
## [Valency](../working-with-pcgex-1/valency/valency/) <sup><mark style="color:$warning;">Experimental<mark style="color:$warning;"></sup>
...
> There's some [basic doc available](../working-with-pcgex-1/valency/valency/) (Ai-generated from the codebase)
...
{% hint style="success" %}
Any new custom property will be available to the systems that use them : [tuple.md](../node-library/quality-of-life/tuple.md "mention"), [valency](../working-with-pcgex-1/valency/valency/ "mention") and [asset-staging](../working-with-pcgex/asset-staging/ "mention")will seamlessly benefit from any additions and improvements.&#x20;
{% endhint %}
...
[mesh-to-clusters.md](../node-library/clusters/mesh-to-clusters.md "mention") now exposes tolerance and have a more precise hash (see [#180](https://github.com/Nebukam/PCGExtendedToolkit/pull/180))
...
Because [clipper2-offset.md](../node-library/paths/clipper2/clipper2-offset.md "mention") is so good at what it does, I entirely removed the clunky "cleanup" options from the old [offset.md](../node-library/paths/offset.md "mention") node — it was not robust and had tons of edge cases, was a pain to maintain — I'm just happy to get rid of that.
