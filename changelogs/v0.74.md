...
### Cell Diagram <sup><mark style="color:$success;">New Node<mark style="color:$success;"></sup>
...
Cell nodes now expose growth parameters to output neighboring cells up to a certain depth. _The same logic applies to holes and "grows" the holes._
