...
**This is a huge one for people building from source;** _folks using the precompiled binaries can stop reading there : there's no new major user-facing feature — those are all in the_ [_0.73.1 Patch_](v0.73.1-feature-patch.md)_._
...
This release does come with a few tweaks and a lot of small bugfixes here and there. But most notably a complete refactor of OBB x OBB checks. This affects [Broken link](/broken/pages/sHOdtsXklQajM77Odzch "mention"), [Broken link](/broken/pages/4BO6r4YVaEAJvy2JpuNl "mention"), [Broken link](/broken/pages/cxxJh7Yy2fHhouPgOVME "mention"), and [Broken link](/broken/pages/UNjWIWpDigNE2hhUTQxd "mention")
