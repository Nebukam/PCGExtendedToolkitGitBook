...
<div><figure><img src="../../.gitbook/assets/image (222).png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/image (224).png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/image (223).png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../../.gitbook/assets/image (232).png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../../.gitbook/assets/image (233).png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../../.gitbook/assets/image (237).png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../../.gitbook/assets/image (243).png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../../.gitbook/assets/image (229).png" alt=""><figcaption></figcaption></figure></div>
...
<div><figure><img src="../../.gitbook/assets/image (244).png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/image (245).png" alt=""><figcaption></figcaption></figure></div>
...
<figure><img src="../../.gitbook/assets/image (248).png" alt=""><figcaption><p>The same snapping options can be found in the "Variations" settings of the asset collections</p></figcaption></figure>

### [Collection to Module Infos](/broken/pages/iYUEF5wGGKQecSJcjTgr)
...
> More of that will come, I have a "Grammar Staging" node down the pipe that will work exactly like [Broken link](/broken/pages/UXgxnf7YZ8yt1AXw1heR "mention")but specifically for points coming out of the grammar workflow.

### [Write States](/broken/pages/f5xZk2yDnM3mvFWAaQr3)

the [Broken link](/broken/pages/f5xZk2yDnM3mvFWAaQr3 "mention")node is the point-friendly version of what used to be called "Flag nodes". It takes [Broken link](/broken/pages/jjPqKnZoS0i8GqKuZzz7 "mention")subnodes to do bitwise operation on an `int64` attribute.

{% hint style="warning" %}
`Flag Nodes` has been renamed [Broken link](/broken/pages/JEC25tBFnxHBNDy79MBU "mention") and `Node Flag`  [Broken link](/broken/pages/6oa9LVWR3KbEIPCWH4sG "mention").\
&#xNAN;_`Cluster : Write States` supports_ [Broken link](/broken/pages/jjPqKnZoS0i8GqKuZzz7 "mention") _nodes, there's not much difference between the two!_
{% endhint %}

<figure><img src="../../.gitbook/assets/image (191).png" alt=""><figcaption></figcaption></figure>

### [State : Bitmask Adjacency](/broken/pages/l6QHRVeXLFh8AVy9sxgF)

The Bitmask Adjacency state is a state that takes bitmask reference and/or [Broken link](/broken/pages/N96TTqPQq9pNVXMkCUrm "mention")and uses internal directions to apply bitmasks directly. It's designed to be pair well with [Broken link](/broken/pages/eMCAFlcLsDh2KTe8kt44 "mention").

<figure><img src="../../.gitbook/assets/image (251).png" alt=""><figcaption></figcaption></figure>

### [Probe : Bitmasks](/broken/pages/eMCAFlcLsDh2KTe8kt44)

Bitmask Probe is a [Broken link](/broken/pages/dcQaxAv265UeaLee5GR7 "mention")**probe** that takes bitmask reference and/or [Broken link](/broken/pages/N96TTqPQq9pNVXMkCUrm "mention")and uses internal directions. It makes it much easier and straightforward to connect direction and then write corresponding states!

<figure><img src="../../.gitbook/assets/image (250).png" alt=""><figcaption></figcaption></figure>

### [Fibonacci Lattices](/broken/pages/Bn89HSVJJ3bPX1TqrZ96) (φ Sphere)

A very cheap sphere shape for the Shape builder, based on[ this awesome paper](https://observablehq.com/@meetamit/fibonacci-lattices).
...
{% hint style="warning" %}
**Parcels is 5.7 only**\
&#xNAN;_&#x4E;ot because it's not possible to do the same in 5.6 but because it's super painful to backport subgraphs._
{% endhint %}
...
<figure><img src="../../.gitbook/assets/image (184).png" alt=""><figcaption><p>Bitmasks can now reference external assets to pick &#x26; compose more complex values </p></figcaption></figure>
...
### [Data Bounds Aspect](/broken/pages/8crUEfO98axIT1MY0mYU)
...
* **UV writing support** for all mesh generators!&#x20;
* Greatly optimized mesh generation speed (_added parallelization everywhere I could_)
* Random Ratio filter now support clamping

### [Path : Solidify](/broken/pages/4IzALifsfdWvD92nFdU0) <sup><mark style="color:$danger;">Refactor<mark style="color:$danger;"></sup>

<figure><img src="../../.gitbook/assets/image (193).png" alt=""><figcaption></figcaption></figure>

The solidify node got a much needed refactor, exposing better controls over the "solidification" process. This is mostly to make it more friendly to use directly with [Broken link](/broken/pages/cLPLrkgysgkezVpY7EH9 "mention").
...
#### [Linetrace](/broken/pages/9PQrdWpeI54pKO5gqZfU) Vertex Color

Line trace node can now extract vertex color at the hit location.

<figure><img src="../../.gitbook/assets/image (249).png" alt=""><figcaption></figcaption></figure>

#### Per-point collection support for asset staging

You can now pick per-point collection for asset staging! It's overkill in most cases but can come it really handy when working with grammar.

#### Easier search

Added a few helpers/broken down some node to make discovery easier (specifically inclusion)

<div><figure><img src="../../.gitbook/assets/image (227).png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/image (228).png" alt=""><figcaption></figcaption></figure></div>
