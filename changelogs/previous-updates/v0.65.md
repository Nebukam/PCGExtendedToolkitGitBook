...
### [Uber Branch](/broken/pages/yO3cLJ97E8j2DrUeI4CZ)
...
<figure><img src="../../.gitbook/assets/image (137).png" alt=""><figcaption><p>Waterfall distribution to output pins</p></figcaption></figure>

### [Branch on Data](/broken/pages/ge86icdH9i9xkxWCeRdQ)
...
### [Verlet Relax](/broken/pages/Yt2zpAQ0wepzt6dpmPh7)

A new relax mode for [Cluster Relax](/broken/pages/aPcr0yDVoqxy1AtotnZH)!

<figure><img src="../../.gitbook/assets/verlet.gif" alt=""><figcaption><p><em>Weeeeee</em></p></figcaption></figure>



### [Reduce Data](/broken/pages/ri7yKzETw95jdsg4g0Ak)

Same as the native `Attribute Reduce`, but works exclusively on @Data domain attributes.

<figure><img src="../../.gitbook/assets/image (133).png" alt=""><figcaption></figcaption></figure>

### [Sample Vtx by ID](/broken/pages/kEhV4Ju0k9Az7CjIbPxN)
...
<figure><img src="../../.gitbook/assets/image (88).png" alt=""><figcaption><p>Find contour on flat cluster then "reproject" them on the modified cluster through Vtx sampling</p></figcaption></figure>

### Uber Filter (Splines) <sup><mark style="color:yellow;">Subgraph<mark style="color:yellow;"></sup>

Not a full cpp node but a handy subgraph that behave exactly like [Uber Filter (Collection)](/broken/pages/Gx5TFUDtP9rfAnVEAR4f) but filters out splines instead.
...
There are some new optimization for the [Cluster' Flood Fill](/broken/pages/E9KTJGb7xOvs8XPALY5X) node relative to paths!\
...
Back in the days, [Offset](/broken/pages/9I57MUYaYfxKbOrIzCWt) had a not-so-good "cleanup" option — it's back, and it's better and more reliable! It has a few edge-cases that are hard to cover, and few things to iron out still, but it proudly handles most common cases.

<figure><img src="../../.gitbook/assets/image (91).png" alt=""><figcaption></figcaption></figure>

### WaitForPCGData

The [WaitForPCGData](/broken/pages/cObTmq2A3AXlkM9TxQqd) node now supports per-data (@Data domain) instance.&#x20;
...
* [Spline to Path](/broken/pages/MGQsqELtenbYQFrYcAjA) now support carrying over spline attributes
* [Voronoi 2D](/broken/pages/vM7M7htQ8tftXkByoPgi) now has 3 additional loose data outputs on Sites:
...
* Sneaky bufix on [Attribute Remap](/broken/pages/cIB6cOKN61Pc4bPD9Jf8) that was crashing the editor if you wanted to output the value to a new attribute.
* [Attribute Remap](/broken/pages/cIB6cOKN61Pc4bPD9Jf8) now properly output single values when remapping a component to a new attributes. Previously remaping `$Position.X` to `RemappedX` would create an entire new vector and set the `.X`, now it outputs a `RemappedX` double.
* [WriteIndex](/broken/pages/FHOHoihpZNLQtEbyp0Qw) now lets you choose the default output attribute type for `NumEntries` & `CollectionIndex`.
