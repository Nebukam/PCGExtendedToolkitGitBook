...
Both spline mesh nodes ([Simple](../../node-library/paths/spline-mesh-simple.md) & [Collection](../../node-library/assets-management/spline-mesh.md)) now expose the familiar Property Override Definitions; letting you override the spawned `USplineMeshComponent`' properties using attributes values.
...
* Added optional self exclusion on [Inclusion](../../node-library/filters/filters-points/spatial/inclusion-path-splines.md) filter, allowing to easily batch-test inclusions
