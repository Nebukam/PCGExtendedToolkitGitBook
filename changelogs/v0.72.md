...
* Added blending support & union stats to [fuse-collinear.md](../node-library/paths/fuse-collinear.md "mention")
* [random-1.md](../node-library/filters/filters-points/random-1.md "mention")now support clamping, allowing to optionally ensure there's a fixed min/max amount of points selected. _That value can be driven by data attributes!_
* Added Hash and UnsignedHash reduction modes to [reduce-data.md](../node-library/metadata/reduce-data.md "mention")!
*
