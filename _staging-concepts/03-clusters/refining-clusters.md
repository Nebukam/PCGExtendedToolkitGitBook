...
<!-- IMAGE: Dense cluster becoming sparse after edge removal -->
...
<!-- IMAGE: Long edges gaining intermediate Vtx points -->
...
<!-- IMAGE: Cluster with nearly-overlapping Vtx becoming cleaner after fusion -->
...
<!-- IMAGE: Irregular cluster becoming more evenly spaced after relaxation -->
...
<!-- IMAGE: Vtx colored by average neighbor attribute value -->
...
- [Building Clusters](building-clusters.md) - Creating clusters
- [Filters](/concepts/04-filters/) - Filter system used by refinement operations
