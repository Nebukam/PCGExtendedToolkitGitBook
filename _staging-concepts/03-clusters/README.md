...
<!-- IMAGE: Diagram showing Vtx points with Edge points between them, labeled to show both are regular PCG points -->
...
<!-- IMAGE: PCG graph showing node with Vtx and Edges input pins -->
...
<!-- IMAGE: Database-style diagram showing Vtx table and Edges table with arrows indicating ID references -->
...
- [The Dual Dataset](the-dual-dataset.md) - Working with Vtx and Edges together
- [Building Clusters](building-clusters.md) - Creating clusters from points, meshes, paths
- [Refining Clusters](refining-clusters.md) - Filtering, simplifying, modifying topology
- [Common Operations](common-operations.md) - Goal-oriented node map: "I want to X → use Y"
- [Cluster-Path Interop](cluster-path-interop.md) - Converting between clusters and paths

## Related

**Concepts:**
- [Paths](/concepts/02-paths/) - The other core data structure
- [Filters](/concepts/04-filters/) - Edge and Vtx filters
- [Pathfinding](/concepts/06-pathfinding/) - Traversing clusters

**Node Library:**
- [Cluster Nodes](/node-library/clusters/) - Complete cluster operation reference
- [Diagram Nodes](/node-library/clusters/generate/diagrams/) - Delaunay, Voronoi, etc.
