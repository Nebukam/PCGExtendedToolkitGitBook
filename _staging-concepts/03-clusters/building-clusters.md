...
<!-- IMAGE: Random point cloud transformed into Delaunay triangulation showing triangle connectivity -->
...
<!-- IMAGE: Points with Voronoi cell boundaries, edges connecting adjacent cell centers -->
...
<!-- IMAGE: Points with K-nearest connections (K=3), showing each point connected to exactly 3 others -->
...
<!-- IMAGE: Grid showing 4-way vs 8-way connectivity patterns -->
...
<!-- IMAGE: Static mesh becoming cluster with same vertex/edge structure -->
...
<!-- IMAGE: Separate path segments becoming interconnected cluster at meeting points -->
...
Newly created clusters often need refinement: removing unwanted edges, filtering Vtx by criteria, subdividing long edges, computing additional attributes. See [Refining Clusters](refining-clusters.md) for post-generation processing.

## Related

- [Cluster Overview](README.md) - Cluster fundamentals
- [Refining Clusters](refining-clusters.md) - Post-generation processing
- [Diagram Nodes](/node-library/clusters/generate/diagrams/) - Delaunay, Voronoi node reference
