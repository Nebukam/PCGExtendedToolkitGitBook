...
<!-- IMAGE: Collection editor interface showing entry list and settings tabs -->
...
Collection A referencing Collection B which references Collection A creates infinite recursion.
{% endhint %}
...
**Assets tab:** Entry list with individual settings
**Collection Settings tab:** Defaults and global configuration
...
- [Distribution](distribution.md) - How entries are selected
- [Fitting](fitting.md) - Transform adjustment
