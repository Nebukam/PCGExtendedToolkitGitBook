...
<!-- IMAGE: Visual showing three entries with weights 50, 30, 20 as proportional pie chart -->
...
**Constant**: All points use the same category (staging node setting)
**Attribute**: Each point's category comes from an attribute value
...
- [Collections](collections.md) - Collection structure and entries
- [Fitting](fitting.md) - Transform adjustment after distribution
