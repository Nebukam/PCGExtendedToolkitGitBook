...
<!-- IMAGE: Multiple heuristic providers connected to a pathfinding node's Heuristics pin -->
...
- [Algorithms](algorithms.md) - How algorithms use heuristics
- [Heuristic Nodes](/node-library/pathfinding/heuristics/) - Complete reference
