...
See [Heuristics](heuristics.md) for heuristic configuration.
...
- [Heuristics](heuristics.md) - Scoring functions
- [Cells and Hulls](cells-and-hulls.md) - Region extraction
