...
<!-- IMAGE: Cluster with cells → generated mesh surface showing triangulated faces -->
...
- [Clusters](/concepts/03-clusters/) - Source topology for mesh generation
- [Paths](/concepts/02-paths/) - Source paths for surface generation
- [Topology Nodes](/node-library/topology/)
