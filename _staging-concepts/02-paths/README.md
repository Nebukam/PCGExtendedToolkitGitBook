...
<!-- IMAGE: Points numbered 0-4 connected by lines showing their order -->
...
<!-- IMAGE: Side-by-side showing open path (line with endpoints) vs closed path (complete loop) -->
...
<!-- IMAGE: Path showing tangent arrows and normal arrows at each point -->
...
- [Segments vs Points](segments-vs-points.md) - The segment mental model for understanding path operations
- [Common Operations](common-operations.md) - Categories of path manipulation

## Related

**Concepts:**
- [Clusters](/concepts/03-clusters/) - The other core data structure
- [Cluster-Path Interop](/concepts/03-clusters/cluster-path-interop.md) - Converting between paths and clusters

**Node Library:**
- [Path Nodes](/node-library/paths/) - Complete path operation reference
