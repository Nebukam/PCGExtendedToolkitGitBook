...
<!-- IMAGE: Diagram showing points P0-P3 with segments S0-S2 labeled between them -->
...
<!-- IMAGE: Segments with arrows pointing to their start points showing data flow -->
...
<!-- IMAGE: Path showing varying offset creating a wavy result, colored by offset value -->
...
- [Common Operations](common-operations.md) - Operation categories
