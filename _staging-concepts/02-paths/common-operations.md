...
| Feed paths into cluster topology | See [Cluster-Path Interop](/concepts/03-clusters/cluster-path-interop.md) | **Path to Clusters** merges endpoints into a connected network. |
...
- [Path Overview](README.md) — Path fundamentals
- [Segments vs Points](segments-vs-points.md) — Understanding segment-based operations
- [Path Nodes](/node-library/paths/) — Complete node reference
