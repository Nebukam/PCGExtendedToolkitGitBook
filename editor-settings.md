...
<table><thead><tr><th width="210">Setting</th><th>Description</th></tr></thead><tbody><tr><td><strong>Default Cache Node Output</strong></td><td>The default caching behavior for PCGEx nodes. <br>See <a href="/broken/pages/UfG2xGK0i2vFyRZt7Tgu#performance-settings">Caching</a> for more info.<br><em>It is recommended to leave this value to default <code>false</code> value.</em></td></tr><tr><td><strong>Default Scoped Attribute Get</strong></td><td>The default attribute read behavior for PCGEx nodes that support it.<br><em>See</em> <a href="/broken/pages/UfG2xGK0i2vFyRZt7Tgu#performance-settings"><em>Performance Settings</em></a> <em>for more info.</em></td></tr></tbody></table>
